...
public class SupplierDetail implements Serializable {
	...
	public String toString() {
		return "SupplierDetail [id=" + id + ", supplierId=" + supplierId + ", nameJC=" + nameJC + ", companyStoreLogo="
				...
				+ contactTel + ", phone=" + phone + ", jyTS=" + jyTS + ", jySJ=" + jySJ + ", locationType="
				+ locationType + ", locationLat=" + locationLat + ", locationLng=" + locationLng
				+ ", locationPoiaddress=" + locationPoiaddress + ", locationPoiname=" + locationPoiname
				+ ", locationCityname=" + locationCityname + ", createTime=" + createTime + ", createBy=" + createBy
				+ ", modifyTime=" + modifyTime + ", modifyBy=" + modifyBy + ", status=" + status + ", attrList="
				+ attrList + ",mainBusiness="+mainBusiness+"]";
	}
