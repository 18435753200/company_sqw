...
public class OnLineSupplier implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2015201999759965179L;
		//公司名称
	    private String name;
	  //公司简称
...
//	    ======================================
		...
		public String toString() {
			return "OnLineSupplier [name=" + name + ", nameJC=" + nameJC + ", provinceId=" + provinceId + ", cityId="
