	...
	List<Object> showSkuCode(SupplierProductObjectDTO proObjVo) {
		...
		if(null != supplierProSkuVOs && supplierProSkuVOs.size() > 0 ){
			...
			for ( int i = 0 ; i< supplierProSkuVOs.size() ; i++ ){
				...
				// 封装价格属性
				String domesticPrice = supplierProSkuVOs.get(i).getSupplierProductPriceMap().getDomesticPrice().setScale(2) + "";
				String unitPrice = supplierProSkuVOs.get(i).getSupplierProductPriceMap().getUnitPrice().setScale(2) + "";
				String bestoayPrice = supplierProSkuVOs.get(i).getSupplierProductPriceMap().getBestoayPrice().setScale(2) + "";
				String priceId = supplierProSkuVOs.get(i).getSupplierProductPriceMap().getPriceId() + "";
				String hqj = supplierProSkuVOs.get(i).getSupplierProductPriceMap().getCashHqj()+"";
				String fhed = supplierProSkuVOs.get(i).getSupplierProductPriceMap().getFhed().setScale(2) + "";
	...
	List<Object> showSkuCodeDealer(DealerProductObjectDTO proObjVo) {
		...
		if(null != supplierProSkuVOs && supplierProSkuVOs.size() > 0 ){
			...
			for ( int i = 0 ; i< supplierProSkuVOs.size() ; i++ ){
				...
				String hqjPrice = supplierProSkuVOs.get(i).getDealerProductPriceMap().getCashHqj()+ "";
				String fhedPrice = supplierProSkuVOs.get(i).getDealerProductPriceMap().getFhed().setScale(2) + "";
				...
				priceIdIndex.add(priceId);
				productCodeIndex.add(productCode);
				hqjIndex.add(hqjPrice);
				fhedIndex.add(fhedPrice);
