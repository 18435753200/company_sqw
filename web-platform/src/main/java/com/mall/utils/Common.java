...
public class Common {
	...
	/**
	 * @Author Zhutaoshen
	 * @Date 2017/1/5 0005 9:04
	 * 判定一个对象类型是否是基本数据类型，字符、数值、日期等
	 * @param aClass
	 * @return
	 */
	public static boolean isBaseDataType(Class aClass) {
		return (aClass.equals(String.class) ||
				...
				aClass.equals(BigInteger.class) ||
				aClass.equals(Boolean.class) ||
				aClass.equals(Date.class) ||
				aClass.equals(DateTime.class) ||
				aClass.isPrimitive());
	}
