		...
		<div class="right">
			...
			<div class="xia">
				<p class="p1">
					...
					<input type="hidden" name="costCode" id="costCode" value="${costCodes }">
					<span>分摊方法：</span>
			...
			<div class="pu_wrap">
	  		...
	  		<div class="pu_bd">
	  			<table id="sho">
	  				...
	  				<c:forEach items="${itemDtos }"  var="i" varStatus="status">
	  				<tr>
	  					<td>${status.index+1 }</td>
		  				<td><input type="checkbox" class="sm"></td>
		  				<td><input type="text" name="business_number" id="business_number" readonly="readonly" value="${i.businessNumberChar }"/></td>
		  				<td><input type="text" name="pcode" id="pcode" readonly="readonly" value="${i.pcode }"/></td>
		  				<td><input type="text" name="barCode" id="barCode" readonly="readonly" value="${i.barCode }"/></td>
		  				<td><input type="text" name="pname" id="pname" readonly="readonly" value="${i.pname }"/></td>
		  				<td><input type="text" name="qty" id="qty" readonly="readonly" value="${i.localQty }"/></td>
		  				<td><input type="text" name="currency_type" id="currency_type" readonly="readonly" value="${i.currencyType }"/></td>
		  				<td><input type="text" name="price" id="price" readonly="readonly" value="${i.totalPrice }"/></td>
		  				<td><input type="text" name="localPrice" id="localPrice" readonly="readonly" value="${i.localTotalPrice }"/></td>
		  				<td><input type="text" name="allocationPrice" id="allocationPrice" readonly="readonly" value="${i.sharePrice }"/></td>
		  				<td><input type="text" name="sku_id" id="sku_id" readonly="readonly" value="${i.skuId }"/></td>
	  				</tr> 
	  				</c:forEach> 
	  			</tbody>
	  			</table>
