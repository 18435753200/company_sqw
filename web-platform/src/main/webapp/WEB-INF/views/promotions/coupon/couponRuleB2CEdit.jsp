...
<head>
<meta charset="UTF-8">
<title>UNICORN-新增B2C优惠券规则</title>
...
<script src="${path}/commons/js/couponRuleB2C.js"></script>
	...
	<div class="center">
			...
			<div class="c2">
				<div class="c21">
					<div class="title">
						<p>促销管理&nbsp;&gt;&nbsp;</p>
						<p>优惠券管理&nbsp;&gt;&nbsp;</p>
						<p class="c1">编辑B2C优惠券规则</p>
					</div>
				</div>
				<div class="blank10"></div>
				<div class="coupon-wrap">
					<div class="coupon-bd manage-coupon manage-act">
						...
						<div class="form-inline">
							...
							<div class="form-group">
								<label for="coupon-type">使用限制：</label>
								<div class="field">
									<select name="visittype" id="visittype" class="coupon-sel">
										<option selected="selected" value="1">不限</option>
										<option value="2">电信充值专用</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="field">
									<select name="ruleCondition" id="ruleCondition"
										class="coupon-sel">
										<option selected="" value="0">全场</option>
										<c:if test="${coupon.coupontype==1}">
						...
						<div class="form-group">
							...
							<c:if test="${coupon.coupontype==2}">
								<input type="text" name="meetpiece" id="meetpiece"
									class="coupon-txt" value="0" disabled="disabled" readonly="readonly">
									<span>￥</span> <span
									class="dpl-tip-inline-warning"></span>
							</c:if>
							<c:if test="${coupon.coupontype!=2}">
						...
						<div class="form-group">
							<label for="coupon-name">设置优惠券总数量：</label>
							<div class="field">
								<input type="text" name="qty" id="qty"
									value="" class="coupon-txt"><span class="red"></span>
							</div>
						</div>
        ...
        <div class="form-box hide J-why" id="J-why-goods">
            <div class="act-goods-hd" style="height: 60px;">
                                        单品名称:<input type="text" name="skuName" id="skuName" class="act-txt" style="width:150px;">
		...
		<div class="form-group">
			<input type="button" name="createRuleB2C" id="createRuleB2C"
