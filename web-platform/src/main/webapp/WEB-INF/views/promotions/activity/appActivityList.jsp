...
<script src="${path}/commons/js/app_activity_list_fn.js"></script>
			...
			<div class="c21">
				...
				<div class="promotion-wrap">
					<div class="promotion-hd">
						<div class="promotion-title">APP活动列表</div>
						...
						<!-- <form action="activeForm" ></form> -->
							...
							<%--<div class="form-group">
								<label for="promotion-date">活动时间：</label> <input type="text"
									name="activityTime" id="activityTime" onClick="WdatePicker()"
									class="promotion-txt promotion-date large">
							</div>
							--%><div class="form-group">
								<input type="button" name="button" id="button" onclick="clickSubmit(1)" class="promotion-btn large" value="查询">
							</div>
						</div>
					</div>
