			...
			<div class="c21">
				...
				<div class="promotion-wrap">
					<div class="promotion-bd manage-promotion">
						<div class="promotion-title">活动详情</div>
						<form method="post" id="activityAction"
							...
							<div class="form-inline">
								<div class="form-group">
									...
									<div class="field">
										<input readonly="readonly" type="text" name="promotion" id="activeName"
								...
								<div class="form-group">
									...
									<div class="field">
										<select disabled="disabled" name="select" id="promotion-section"
											class="promotion-sel">
							...
							<div class="form-inline">
								<div class="form-group">
									...
									<div class="field">
										<input type="text" readonly="readonly" name="promotion"
											id="promotion-startTime" class="promotion-txt"
								...
								<div class="form-group">
									...
									<div class="field">
										<input type="text" readonly="readonly" name="promotion"
											id="promotion-endTime" class="promotion-txt"
											value="<fmt:formatDate
							...
							<div class="form-inline">
								<div class="form-group">
									<label for="promotion-organizersType">主办方类型：</label> <select disabled="disabled"
										name="select" id="promotion-organizersType"
										class="promotion-sel">
										<option value="1">平台</option>
									</select>
								</div>
								<div class="form-group">
									<label for="promotion-organizers">主办方：</label> <select disabled="disabled"
										name="select" id="promotion-organizers" class="promotion-sel">
										<option value="1">运营部</option>
									</select>
								</div>
							</div>
							<%-- <div class="form-inline">
								<div class="form-group">
									...
									<div class="field">
										<input type="text" name="promotion" id="ratio"
											class="promotion-txt" value="${bean.ratio }"><span>%</span>
									</div>
								</div>
								<div class="form-group">
									<label for="promotion-picLink">图像链接：</label>
									<div class="field">
										<input type="text" name="promotion" id="imageUrl"
							...
							<div class="form-inline">
								<div class="form-group">
									...
									<div class="field">
										<input type="text" name="promotion" id="linkUrl"
								...
								<div class="form-group">
									...
									<div class="field">
										<input type="text" name="promotion" id="linkCode"
											class="promotion-txt" value="${bean.linkCode }">
									</div>
								</div>
							</div> --%>
							<div class="form-group">
								<label for="promotion-organizers">活动类型：</label> <select disabled="disabled"
