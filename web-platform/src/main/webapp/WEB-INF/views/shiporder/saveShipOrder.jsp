...
var result=0;
 $(document).ready(function(){
    ...
    if(pro_array.length==$("input[name='qtyReceived']").length)
    {
    	result=2;
    }
 });
	 ...
	 <div class="left f_l">
		...
		<div class="right">
			...
			<div class="xia">
				<p class="p1">
					<span>物流通知单编号:</span>
					<input type="text" name="keyChar" id="keyChar" value="${keyChar}" readonly="readonly">
					<input type="hidden" name="id" id="id" value="${key}"/>
					<input type="hidden" name="notificationId" id="notificationId" value="${notificationId}"/>
					<input type="hidden" name="businessNumber" id="businessNumber" value="${businessNumber }"/>
					<span>采购订单编号:</span>
					<input type="text" name="bussChar" id="bussChar" value="${orderDTO.notificationOrder.businessNumberChar}" readonly="readonly">
					<span>入库通知编号:</span>
					<input type="text" name="noChar" id="noChar" value="${orderDTO.notificationOrder.notificationChar }" readonly="readonly">
				</p>
				<p class="p1">
					<span>预计送达时间:</span>
					<input type="text" name="arriveDate" id="arriveDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});">
					<span>服务商名称:</span>
				    <input type="text" id="serviceName" name="serviceName" value="${orderDTO.notificationOrder.serviceName }" readonly="readonly">
				    
				  
				</p>
				<p class="p1">
					  <span>服务商编号:</span>
				    <input type="text" id="serviceCode" name="serviceCode" value="${orderDTO.notificationOrder.serviceCode }" readonly="readonly">
					<span>运输方式:</span>
				...
				<p class="p1">
					<span>送货地址:</span>
					<input type="text" class="inp" id="receiveAddress" name="receiveAddress" value="${orderDTO.notificationOrder.sendAddress }" readonly="readonly">
				</p>
				<p class="p1">
					<span>联系人:</span>
					<input type="text" id="receiveName" name="receiveName" value="${orderDTO.notificationOrder.receiveName }" readonly="readonly">
					<span>联系电话:</span>
					<input type="text" id="receivePhone" name="receivePhone" value="${orderDTO.notificationOrder.receivePhone }" readonly="readonly">
				</p>
			</div>
				...
				<div class="pu_h"><h3>货物明细</h3></div>
		  		<div class="pu_b">
		  			<table>
		  				...
		  				<c:forEach var="result" varStatus="status" items="${pageBean.result }">
		  				<tr>
			  				...
			  				<td><input type="text" name="qty" id="qty" value="${result.qty }" readonly="readonly" style="border:0px;text-align:center;"/></td>
			  				<td><input type="text" name="tallQty" id="tallQty" value="${result.qtyReceived }" readonly="readonly" style="border:0px;text-align:center;"/></td>
			  				<td><input type="text" name="qtyReceived" id="qtyReceived${status.index+1 }" value="${result.qtyReceived-result.pid}" qty="${result.qtyReceived }" qtyReceived=${result.pid } style="border:0px;text-align:center;" onblur="checkQty($(this));" readonly="readonly"/></td>
