...
<title>供应商-商品详情页</title>
<!-- css -->
<%@include file="/WEB-INF/views/include/base.jsp"%>
<link href="${path }/commons/css/base.css" rel="stylesheet" type="text/css">
<link href="${path }/commons/css/productprewiew.css" rel="stylesheet" type="text/css">
</head>
			...
			<div class="p-detail-bd tab-bd hide">
				...
				<div class="tab_box2">
					<p class="p1" style="width:900px; height:260px; display: block; font-size:13px; color:#858384;">
						...
						众聚商城保证所售商品均为正品行货，开具机打发票或电子发票，与您亲临商场选购的商品享受相同的质量保证。众聚商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！<br/>
						...
						众聚商城上的所有商品信息、客户评价、商品咨询、网友讨论等内容，是众聚商城重要的经营资源，未经许可，禁止非法转载使用。
					</p>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="${path}/commons/js/scripts.js"></script>
<script type="text/javascript" src="${path}/commons/js/jquery.lazyload.js"></script>
