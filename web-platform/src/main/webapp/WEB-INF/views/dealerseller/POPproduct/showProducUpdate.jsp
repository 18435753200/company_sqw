...
<script type="text/javascript" src="${path}/commons/js/viewProduct.js"></script>
			...
			<div class="border">
				...
				<div class="cont">
					...
					<div class="i_box">
						...
						<div class="p_box">
							<p class="p1 <c:if test="${proObj.supplierProduct.productNameFlag == 1}">c_red</c:if>" >
								<i class="c_red">*</i> 
								商品标题：
							</p>
							<p class="p2">
							...
							<div class="p3">
								<div class="bb">
									<p class="blank10"></p>
									<!-- 基本属性属性值 -->
									 <p class="p1 <c:if test="${proObj.supplierProduct.brandFlag == 1}">c_red</c:if>">
								      <i class="c_red">*</i>主品牌：
							       </p>
							       <p class="t2">
									...
									<c:forEach items="${proObj.supplierProductAttrDTOs}" var="supplierProductAttr" varStatus="vs">
										...
										<c:if test="${supplierProductAttr.supplierProductAttr.saleAttr != 1 && supplierProductAttr.supplierProductAttr.buyAttr != 1 }">
											<p class="p1 <c:if test="${supplierProductAttr.supplierProductAttr.attrFlag == 1}">c_red</c:if>" title="${fn:escapeXml(supplierProductAttr.supplierProductAttr.attrNameCn)}">
									...
									<p class="blank10"></p>
									<p class="p1 <c:if test="${proObj.supplierProduct.originplaceFlag == 1}">c_red</c:if>">
										<i class="c_red">*</i> 原产国：
									</p>
									<p class="t2">
									...
									<p class="blank10"></p>
									<p class="p1 <c:if test="${proObj.supplierProduct.manufacturersFlag == 1}">c_red</c:if>">
										<i class="c_red">*</i> 制造商：
									</p>
									<p class="t2">
									...
									<p class="blank10"></p>
										<p class="p1 <c:if test="${proObj.supplierProductDetail.sheilLifeFlag == 1}">c_red</c:if>">保质期：</p>
										<p class="t2">
								...
								<p class="blank10"></p>
								<p class="blank10"></p>
									<p class="p1 <c:if test="${proObj.supplierProductDetail.customCodeFlag == 1}">c_red</c:if>">海关税则代码：</p>
									<p class="t2">
								...
								<p class="blank10"></p>
									...
									<p class="p1 <c:if test="${proObj.supplierProduct.remarkFlag == 1}">c_red</c:if>">商品备注：</p>
									<p class="t2">
					...
					<div class="i_box">
						...
						<div class="p_box">
							...
							<div class="p3">
								<p class="blank5"></p>
								<p class="t1 <c:if test="${proObj.supplierProductPackage.measureidFlag== 1}">c_red</c:if>"><i class="c_red">*</i>计量单位：</p>
								<p class="s_1">
									<input type="text" id="measure" disabled="disabled" value="${fn:escapeXml(proObj.supplierProductPackage.measureCname)}">
								</p>
								<p class="blank5"></p>
								<p class="t1 <c:if test="${proObj.supplierProductSaleSetting.moneyUnitFlag == 1}">c_red</c:if>"><i class="c_red">*</i>计价单位：</p>
								...
								<div <c:if test="${supplierType eq 3 }">style="display: none"</c:if> >
									<p class="t1 <c:if test="${proObj.supplierProductDetail.priceTypeFlag == 1}">c_red</c:if>"><i class="c_red">*</i> 价格类型：</p>
						...
						<p class="blank15"></p>
						<p class="t1 <c:if test="${proObj.supplierProductDetail.deliverDateFlag == 1}">c_red</c:if>"><i class="c_red">*</i>预计发货日期：</p>
						<p class="s_1">
							...
							<p class="blank15"></p>
							<p class="t1 <c:if test="${proObj.supplierProductDetail.produceNumFlag == 1}">c_red</c:if>"><i class="c_red">*</i>生产能力：</p>
							<p class="s_3">
								...
								<select name="supplierProductDetail.produceType" disabled="disabled" >
									...
									<br>
																...
																<p class="blank15"></p>
								<p class="t1 <c:if test="${proObj.supplierProductDetail.receiveDateFlag == 1}">c_red</c:if>"><i class="c_red">*</i>最后收单日期：</p>
								<p class="s_1">
							...
							<div class="mingxi">
								...
								<div class="mm">
									<p class="m2 <c:if test="${proObj.supplierProductDetail.packingListFlag == 1}">c_red</c:if>">
										<span>包装清单：</span>
									...
									<p class="m3 <c:if test="${proObj.supplierProductDetail.salesServiceDescriptionFlag == 1}">c_red</c:if>">
										<span>售后服务：</span>
									...
									<p class="m4 <c:if test="${proObj.supplierProductDetail.salesCallsFlag == 1}">c_red</c:if>">
