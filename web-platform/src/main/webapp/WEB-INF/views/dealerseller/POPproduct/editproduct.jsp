					...
					<div class="mo_wrap">
						...
						<div class="p_box">
							...
							<div class="p3" id="attrobjs">
							       ...
							       <p class="t2">
								       <input type="text" value="${fn:escapeXml(proObj.brand.nameCn)}" disabled="disabled">
								       <input type="hidden"  name="brand.nameCn" value="${fn:escapeXml(proObj.brand.nameCn)}"/>
									</p>
									<p class="blank10"></p>
							       ...
							       <p class="t2">
									...
									<p class="t2">
										<input required="required" 	type="text" name="dealerProduct.imageAlt"
									...
									<p class="t2">
										<input required="required" 	type="text" name="dealerProductDetail.prodB2btitle" 
						...
						<div class="jinben">
							...
							<div class="download"><input type="button" value="下载图片"  class="download-btn" id="J-downloadPic" /></div>
												...
												<thead>
													...
													<tr>
														...
														<c:forEach items="${proObj.dealerProductAttrDTOs }" var="attr" varStatus="saleVs">
															...
															<c:if test="${attr.dealerProductAttr.saleAttr == 1}">${fn:escapeXml(attr.dealerProductAttr.attrNameCn)}</c:if>
							...
							<div class="mingxi">
								...
								<div class="mm">
									<p class="m2">
										...
										<textarea required="required" name="dealerProductDetail.packingList" id="packinglist">${fn:escapeXml(proObj.dealerProductDetail.packingList)}</textarea>
									</p>
									<span class="dpl-tip-inline-warning">请填写 包装清单</span>
									<p class="m6">
										<span><i class="c_red">*</i>物流描述：</span>
										<textarea  required="required" name="dealerProductDetail.logisticsDescription" id="logisticsDescription">${fn:escapeXml(proObj.dealerProductDetail.logisticsDescription)}</textarea>
									</p>
									<span class="dpl-tip-inline-warning"></span>
									<p class="m3">
