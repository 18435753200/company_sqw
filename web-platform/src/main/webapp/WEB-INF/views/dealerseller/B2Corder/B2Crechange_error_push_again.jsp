...
<head>
	...
	function toPage(page){
		byErrorReSearchCustomerOrderPush(page,"orderType");
	}
		...
		<form action="">
			...
			<p class="p1">
				...
				<option value="">全部方式</option>
				 ...
				 <span>手机号 :</span><input type="text" id="receiveMobilePhone">
			</p>
			<p class="p1">
			     <span>配送方式 :</span>
				 <select id="shipType">
			...
			<p class="p2">
				<button type="button" onclick="searchCustomerReErrorOrderPush()">搜索</button>
