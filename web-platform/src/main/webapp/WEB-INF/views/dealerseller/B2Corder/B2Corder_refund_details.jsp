...
<div class="wrap" id="orderDetail">
	<div class="logo3">
		<p class="p1">您的位置： 订单管理&gt;<a href="#">退款订单</a>&gt;<span>订单详情</span></p>
    ...
    <div class="order-item">
     ...
     <c:if test="${orderDTO.supplyType ne 1}">
             <div class="order-item">
		       <div class="order-hd">
		           <h2>物流信息</h2>
		       </div>
   ...
   <c:if test="${orderDTO.supplyType eq 1}">
    ...
    <div class="order-item">
            ...
            <table class="tb-void">
            	...
            	<c:forEach items="${orderDTO.orderItemDTOs }" var="orderItemDTO">
	            	<tr>
	            		...
	            		<td><fmt:formatNumber value="${orderItemDTO.price }" pattern="0.00#"/>/${orderItemDTO.unit } </td>
	            		<td>${orderItemDTO.skuQty }${orderItemDTO.unit }</td>
	            		<td>
            				<c:if test="${orderDTO.status eq  1}">待支付</c:if>
							<c:if test="${orderDTO.status eq  21}">已支付</c:if>
							<c:if test="${orderDTO.status eq  31}">待海关审核</c:if>
      ...
      <div class="total">
			<ul>
				...
				<li><span> - 返现：</span>￥<fmt:formatNumber value="${orderDTO.discountPrice }" pattern="0.00#"/></li>
