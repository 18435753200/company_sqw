...
<head>
	...
	<script type="text/javascript" src="${path}/commons/js/order_js/b2c_order_cancel.js"></script>
	...
	$(document).ready(function(){
		...
		$.ajax({ 
		     async:false,
		     type : "post", 
		     data:{"statusList":"21,41,81,","pageType":"orderFaile","supplyType":"1"},
