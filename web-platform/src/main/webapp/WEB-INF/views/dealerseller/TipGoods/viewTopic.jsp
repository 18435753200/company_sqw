...
<div class="jh-main">
			...
			<form method="post" id="productAction" enctype="multipart/form-data">
				<ul class="jh-list">
			     	<li>
						<label>分 类：</label>
						<select name="activityType" id="selt"  readonly="readonly">
					...
					<li>
						<label>标 题：</label>
						<input name="title" type="text" class="inputname"  readonly="readonly" value="${dto.title }">
					</li>
					<li class="hdlj" style="display:none;">
						<label>活动链接：</label>
						<input name="viewUrl" type="text" class="inputname"  readonly="readonly" value="${dto.viewUrl }">
					</li>
					<li class="splj"  style="display:none;">
						<label>视频连接：</label>
						<input name="viewUrl" type="text" class="inputname"  readonly="readonly" value="${dto.viewUrl }">
					</li>
					<li>
					...
					<li>
						<label>简 述：</label>
						<textarea name="sketich" cols="" rows="" class="textcent"  readonly="readonly">${dto.sketich }</textarea>
					</li>
