...
<div class="jh-main">
			...
			<form method="post" id="productAction" enctype="multipart/form-data">
				<ul class="jh-list">
					...
					<li>
					<input name="topicId" type="hidden" class="inputname" value="${dto.topicId }">
						<label>标 题：</label>
						<input name="title" id="title" type="text" class="inputname" value="${dto.title }">
						<span style="display:none;" id="titleHidden">最多显示20个字</span>
					</li>
					<li class="hdlj" style="display:none;" id="activityUrlLi">
						<label>活动链接：</label>
						<input name="activityUrl" id="activityUrl" type="text" class="inputname" value="${dto.viewUrl }">
						<span style="display:none;" id="activityUrlHidden">请填写活动连接</span>
					</li>
					<li class="splj"  style="display:none;" id="viewUrlLi">
						<label>视频连接：</label>
						<input name="viewUrl" id="viewUrl" type="text" class="inputname"  value="${dto.viewUrl }">
						<span style="display:none;" id="viewUrlHidden">请填写视频连接</span>
					</li>
					<li>
						<label>首 图：</label>
                        <div class="upimg">
						...
						<span >图片大小等于：小于100K</span>
					</li>
					<li>
						<label>简 述：</label>
						<textarea name="sketich" cols="" rows="" class="textcent" id="sketich">${dto.sketich }</textarea>
						<span >文字控制在500之内</span>
					</li>
...
<!-- 							<button class="fabu_btn" id="previewProd" type="button">预览</button> -->
							<button class="fabu_btn" id="updateActivityTopic" type="button">修改</button>
							<p class="clear"></p>
						</div>
					</li>
				</ul>
	...
	$(document).ready(function(){
		...
		var titleUrl = "${dto.titleUrl}";
		if(titleUrl!=""){
			adduploadimg2('topic','00',titleUrl); 
		}
	});
