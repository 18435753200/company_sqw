...
<head>
    ...
    <script type="text/javascript" src="${path}/commons/js/notification_in_item_update_fn.js"></script>
	...
	<div class="left f_l">
		...
		<div class="right">
			...
			<div class="xia">
				<p class="p2">
					<div class="btn">
						<button type="button"  onclick="updateNotificationOrder()">保存</button>
						<button type="button"  onclick="checkNotificationOrder(this)">审核</button>
					</div>
				</p>
