...
<head>
	<meta charset="UTF-8">
	<title>库存冻结查询(界面)</title>
	<%@include file="/WEB-INF/views/include/base.jsp"%>
	<link rel="stylesheet" type="text/css" href="${path}/commons/css/reset.css"> 
    <link rel="stylesheet" type="text/css" href="${path}/commons/css/move_finish.css">
    <script type="text/javascript" src="${path}/commons/js/move_list.js"></script> 
			...
			<form id="moveFinishPO_fm">
				...
				<div class="xia">
					...
					<p class="p2">
						...
						<button onclick="exportMoveFinishExcel()" type="button" class="dc-btn">导出</button>
					</p>				
				</div>				
			</form>
	   </div>
