	  		...
	  		<div class="pu_b">
	  			<table id="sho">
	  				...
	  				<tr>
		  				...
		  				<td><input type="text" readonly="readonly" name="localTotalPrice" id="localTotalPrice${status.index+1 }" value="${item.localTotalPrice }"/></td>
		  				<td><input type="text" name="tax" id="tax${status.index+1 }" value="${item.tax }" onBlur="sumTaxPrice(${status.index+1 })"/></td>
		  				<td><input type="text" readonly="readonly" name="taxPrice" id="taxPrice${status.index+1 }" value="${item.taxPrice }"/></td>
		  				...
		  				<td><input type="text" readonly="readonly" name="currencyType" id="currencyType${status.index+1 }" value="${item.currencyType }"/></td>
