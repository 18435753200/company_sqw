...
<div class="pu_bd">
	  			<table>
	  				...
	  				<tr>
		  				...
		  				<td>
		  				<c:if test="${result.status==1 }"><a href="${path }/Invoice/InvoiceUpt?sid=${result.sid}">审核</a></c:if>
		  				<c:if test="${result.status==10 }"><a href="${path }/Invoice/InvoiceSelect?sid=${result.sid}">查看</a></c:if>
		  				</td>
	  				</tr>
	  				</c:forEach>
	  			</tbody>
