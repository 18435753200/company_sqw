			...
			<div class="c22">
				...
				<div class="xia">
					<form id="SearchFrom"  action="${path}/user/checklist1" method="post" >
						<p class="p1">
						    <strong>家庭号名称：</strong><input type="text" id="productName" name="name" value="${page.parameter.name}" class="text1 dzf-txt">
...
<%-- 					 			</c:if> --%>
							   ...
							   <form id="viewForm" action="${path}/user/viewInfonew" method="post">
