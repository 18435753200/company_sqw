...
<table>
	...
	<c:forEach items="${pb.result}" var="complaint">
		<tr>
			...
			<td><a href="javascript:void(0)" onclick="retailer_getReplyComplaint_show('${complaint.complaintId }')" class="she">查看</a></td>
			<td>
			   <a href="javascript:void(0)" onclick="retailer_getReplyComplaint_edit('${complaint.complaintId }')" class="she">处理记录</a>
		     <!-- <a href="#" class="schu">删除</a> --></td>
		</tr>
	</c:forEach>
</table>
<c:if test="${!empty pb.result}">
