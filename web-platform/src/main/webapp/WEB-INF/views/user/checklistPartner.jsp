			...
			<div class="c22">
			    <div class="c21">
						<ul class="top">
							...
							<li <c:if test="${1==page.parameter.source }">class="list" </c:if> id="supplier"><a href="javascript:void(0)" onclick="toGetList(1,'jump')">家庭号</a></li>
				...
				<div class="xia">
					<form id="SearchFrom"  action="${path}/user/checklist1" method="post" >
						<p class="p1">
						    <strong>区域运营商名称：</strong><input type="text" id="productName" name="name" value="${page.parameter.name}" class="text1 dzf-txt">
...
<%-- 					 			</c:if> --%>
							   ...
							   <form id="viewForm" action="${path}/user/viewInfoPartner" method="post">
