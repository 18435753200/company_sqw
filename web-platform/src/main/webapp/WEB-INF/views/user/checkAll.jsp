			...
			<div class="c22">
			    <div class="c21">
						<ul class="top">
							...
							<li <c:if test="${1==page.parameter.source }">class="list" </c:if> id="supplier"><a href="javascript:void(0)" onclick="toGetList(1,'jump')">普通商户</a></li>
				...
				<div class="xia">
					<form id="SearchFrom"  action="${path}/user/checklist" method="post" >
						<p class="p1">
...
<%-- 					 			</c:if> --%>
							   ...
							   <form id="viewForm" action="${path}/user/viewInfo" method="post">
