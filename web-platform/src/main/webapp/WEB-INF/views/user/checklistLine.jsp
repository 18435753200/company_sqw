...
<head>
	...
	<script type="text/javascript">
		...
		function  downCheckListExcel(){
			...
			window.open("${path}/user/downchecklistLine?"+data+"&math="+Math.random(),"_blank");
			...
			<div class="c22">
			    <div class="c21">
						<ul class="top">
							...
							<li <c:if test="${1==page.parameter.source }">class="list" </c:if> id="supplier"><a href="javascript:void(0)" onclick="toGetList(1,'jump')">线下商户</a></li>
				...
				<div class="xia">
					<form id="SearchFrom"  action="${path}/user/checklistLine" method="post" >
						<p class="p1">
...
<!-- 						    	</select> -->
<%-- 						    </c:if> --%>
						    <button type="button"  onclick="toGetList('${page.parameter.source}')" style="margin-left: 670px;">搜索1</button>
...
<%-- 					 			</c:if> --%>
							   ...
							   <form id="viewForm" action="${path}/user/viewInfoLook" method="post">
							   ...
							   <form id="viewForm3" action="${path}/user/viewInfo3" method="post">
