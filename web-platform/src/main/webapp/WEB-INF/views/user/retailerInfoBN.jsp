		...
		<div class="right f_l">
			...
			<div class="cont">
					...
					<div class="itemright">
						<ul>
							<c:if test="${!empty dataFile.businessLicenseUrl  }">
								<a href="${path}/user/downloadFile?url=${picUrl}${dataFile.businessLicenseUrl}"><li><img src="${picUrl}${dataFile.businessLicenseUrl}" width="63px" height:"54px"></li></a>
							</c:if>
							<!-- 
				...
				<div class="item" id="ok">
					...
					<div class="itemright">
						...
						<c:if test="${not empty dataFile.effectiveCertificateUrl }">
							<a href="${path}/user/downloadFile?url=${picUrl}${dataFile.effectiveCertificateUrl}"><img src="${picUrl}${dataFile.effectiveCertificateUrl}" width="63px" height:"54px"></a>
						</c:if>
						<!-- 
							<li><img src="${path}/commons/images/keep.png" width="63px" height:"54px"></li>
							<li><img src="${path}/commons/images/keep.png" width="63px" height:"54px"></li>
				...
				<div class="item">
					<label>商户销售渠道：</label>
					<div class="itemright">
						<select class="sm" name="channelId">
							<option value="">请选择</option>
				...
				<!-- 
				 ...
				 -->
				    <a href="javascript:void(0)" onclick="subUpdate()">备案</a>
