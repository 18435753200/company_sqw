...
//         // 初始化swfUpload组件
//         $("#hongse_upload").uploadify({
//             // File Upload Settings
//             'height': 30,
//             'swf': '../js/uploadify/uploadify.swf',
//             'uploader': '../Plugins/UploadHandler.ashx',
//             'width': 100,
...
//             //onDialogClose: fileDialogComplete,
...
//             // Button Settings
//             //button_image_url: "/common/css/i/up_btn.png",
...
function uploadSuccess(file, serverData) {
    ...
    try {
        ...
        if (serverData.success) {
            ...
            'src="'+ serverData.data.Url + '"/>'+"<input type='hidden' name='imgUrl' value='"+id+"_"+serverData.data.Url+"'>")
              .hide()
            ;
