...
$(function(){
	...
	$(".btn_red").click(function(){
		if(g_obj==""||g_obj.attr("pid")=="1"){
			return false;
		}else{
			var val=g_obj.attr("pval");
			var oldhost = $("#hidoldhost").val();
			var url="http://localhost:8080/web-supplier/product?cid="+val;
...
function _fdbCss(obj,node){
	_fdbCss2(obj);
	var val=parseInt(obj.attr("pval"));
	var host = $("#hidhost").val();
	f_fAjax("post","/web-supplier/categoryData",{parent_cid:val},node);
}
