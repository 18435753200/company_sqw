...
function getRedPacket() {
	...
	var _dataType = "text";
	var _type = "POST";
	var _url = $("#path").val()+"/customerActivity/getRedPacket";
	var _async = true;
	var _data = "mobile="+mobile + "&verificationCode=" + verificationCode + "&captcha=" + captcha;
	$.ajax({
		dataType : _dataType,
		type : _type,
		url : _url,
...
function getCode(){
	...
	var _async = true;
	var _data = "mobile="+mobile + "&origin=" + "906" + "&captcha=" + captcha;
	$.ajax({
		dataType : _dataType,
		type : _type,
		url : _url,
