    ...
    if (position.y > 30) {
      ...
      setTimeout(function () {
        ...
        */
        ...
        window.location.href=$("#path").val()+"/wealth/userMoneyJL?supplierId="+supplierId;
...
function reloadData(page) {
	...
	$.ajax({
		type: 'POST',
		url: $("#path").val()+'/wealth/more_shouYinJiLuUser',
		dataType: 'json',
		async:false,
		data:"page="+ page+"&supplierId="+supplierId+"&day="+today,
