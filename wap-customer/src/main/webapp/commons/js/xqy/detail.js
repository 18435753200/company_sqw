					...
					case '40000':
						createDom({
							...
							cancelCallback : function(e) {
								// 取消;
								location.href = "http://m.3qianwan.com/searchController/toSearchResult?cdid=007009";
							},
							sureCallback : function() {
								// 确定;
								location.href = "http://m.3qianwan.com/";
							}
						});
						break;
					case '41000':
						 ...
						 * "http://m.3qianwan.com/searchController/toSearchResult?cdid=007009"; },
...
function changePrice(element) {
	...
	if (homeShangPin == 6 ||(xjzfblbq==1&&cashHqj!=0)) {
	...
	if (moneyAndHqHqj == 0 &&moneyAndHqFhed==0) {
			...
			if (null != data && data.length > 0) {
				...
				for (var i = 0; i < data.length; i++) {
					html += "<li>" + "<h2><a href='" + $("#path").val()
							+ "/item/get/" + data[i].pid
							+ "'><img src='http://image01.3qianwan.com/"
