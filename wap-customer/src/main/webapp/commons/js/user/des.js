 ...
 */
function strEnc(data, mobile) {

	var firstKey = mobile.substring(5, 6);
	//alert("firstKey" + firstKey);
	var secondKey = mobile.substring(8, 9);
	//alert("secondkey" + secondKey);
	var thirdKey = mobile.substring(4, 5);
	//alert("thirdkey" + thirdKey);
