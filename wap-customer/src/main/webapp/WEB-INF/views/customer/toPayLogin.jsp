...
<head>
    ...
    <script type="text/javascript">
		$(document).ready(function(){
			...
			if (openType == 'aliPay' && openId == 'null') {
                var url = $("#path").val() + "/customer/thirdAuthorize?openType=alipay";
				window.location.href = url;
			}

			if(openType!='weixin'&& openType!='aliPay'){
				window.location.href=$("#path").val()+"/Qr/isNotWx";
			}
