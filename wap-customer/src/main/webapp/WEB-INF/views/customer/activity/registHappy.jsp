...
<html>
	<head>
        ...
        <link href="${staticFile_s}/commons/css/userActivity/happy.css" rel="stylesheet" type="text/css">
...
<input type="hidden" id="path" value="<%=path %>"/>
	  <div class="activity-m">
			<form action="" method="get">
				...
				<div class="activity-list">
					<ul>
						...
						<li>
							<input name="" type="password" placeholder="请输入6-20位数字和字母组合构成的密码" class="tet" id="password" >
						</li>
					</ul>
		...
		<script src="${staticFile_s}/commons/js/userActivity/registHappy.js" type="text/javascript"></script>
