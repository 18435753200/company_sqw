...
<header class="aui-bar aui-bar-nav">
        <a class="aui-pull-left aui-btn" href="${path }/wealth/detail_shzxddsr">
...
<div class="jyjl">
    ...
    padding-left: 1rem;"/><i class="aui-iconfont aui-icon-down" style="    position: absolute;    top:0.8rem;    right: 5.5rem;"></i></p>
		<p style="position: relative;   top: -0.3rem;">金额:￥${earningByUserAndDay }</p></h4>
</div>
</div>
       ...
       <c:forEach items="${pageBean.result }" var="detail" varStatus="var">
         <li class="list-item">
          <div class="aui-card-list">
			            ...
			            <a href="${path }/wealth/detail_shzxddsrxq?recordId=${detail.id}"><div class="jyxq_n">交易详情<span style="float: right;"><div class="aui-list-item-right"><div class="aui-list-item-inner aui-list-item-arrow"></div></div></span></div>
			            </a>
			</div>
        </li>
       </c:forEach>   
...
$("#birth").live("change", function() {
	...
	window.location ="${path }/wealth/detail_shzxddsr_rjs?day="+startTime; 
});
//比较日期
