...
<input type="hidden" id="basePath" value="<%=basePath %>"/>	
	...
	<div class="wrap" id="myinfo">
		<div class="wealth">
		 ...
		 <ul class="form-list">
		 	 <a href="<%=path %>/wealth/detail_n/3">
		 	 <li>
	 	 		<div class="label">代金券账户</div>
	            <div class="field"><i class="zh">${wealth.arrivedFlag}</i></div>
		     </li>
		     </a>
		     
		     <a href="<%=path %>/wealth/detail_n/6">
		     <li>
	 	 		<div class="label">分享收入现金金额</div>
	            <div class="field"><i class="zh">${wealth.unArrivedFlag}</i></div>
		     </li>
		     </a>
		 
		 	<a href="<%=path %>/wealth/detail_n/5">
		 	 <li>
	 	 		<div class="label">分享额度</div>
		   ...
		   <div class="form-btn">
		   	 <div class="exit">
		       <a href="javascript:;" onclick="toTransferIndex();"  class="bg" >代金券转账</a>
		    </div>
		   </div>  	
	</div>
</body>
