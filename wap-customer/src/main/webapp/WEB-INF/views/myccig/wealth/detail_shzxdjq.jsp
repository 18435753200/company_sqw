...
.list-item{color:#999999;padding-top:0.75rem;background:white;font-size:0.6rem;}
.aui-card-list-header{padding:0;}
.aui-card-list {
    position: relative;
    margin: 0;
    padding: 0.5rem;
...
.aui-info-item{width:50%;    -webkit-box-sizing: border-box;
...
<h4 style="text-align: center;background: #fff;font-size:0.8rem;border-bottom: 1px solid #F7F4F4;line-height: 2rem">交易记录</h4>
</div>
<div class="aui-btn aui-btn-danger aui-btn-block"><a href="${path}/wealth/turnVoucher" onclick="toTransferIndex();" style="color:#fff">转账</a></div>
<div class="list-wrapper list-wrapper-hook">
        ...
        <li class="list-item">
          <div class="aui-card-list">
       		            <div class="aui-card-list-header">
			                 <div class="aui-info-item"><span class="aui-margin-l-0" style="padding-left:0.5rem"><fmt:formatDate value="${detail.operatorTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></span></div>
                             <div class="aui-info-item">交易号：${detail.refObjId}</div>
			            </div>
			            <div class="aui-card-list-content-padded">
							<%-- <b style="font-weight: 500;">${detail.resultType}</b> --%>
  ...
  <script src="${staticFile_s}/commons/js/index_shzxdjq.js"></script>   	
<script>
