...
<div class="jyjl">
	<div style="float: left;width: 72%;">	
		<h4 class="jyjl_xx"><fmt:formatDate value='${today}' pattern='yyyy-MM-dd'/><p>金额:￥${balanceSumByUserAndDay }</p></h4>
	</div>
	<a href="${path }/wealth/detail_grzxfxsr_rjs">
		<div class="jyjl_rjs">
      ...
      <ul class="list-content list-content-hook" id="thelist">
        ...
        <li class="list-item">
          <div class="aui-card-list">
			            ...
			            <a href="${path }/wealth/detail_fxsrxq?recordId=${detail.id}"><div class="jyxq_n">交易详情<span style="float: right;font-family: cursive;">></span></div></a>
			</div>
        </li>
        </c:forEach>   
      </ul>
