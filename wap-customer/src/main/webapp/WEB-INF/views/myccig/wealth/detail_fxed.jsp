...
<!-- <div class="aui-btn aui-btn-danger aui-btn-block"><a href="javascript:;" onclick="toTransferIndex();" style="color:#fff">代金券转账</a></div> -->
       ...
       <li class="list-item">
          <div class="aui-card-list">
			            ...
			            <div class="aui-card-list-content-padded">
							...
							<b style="color: red;font-size: 0.9rem;margin-left: 0.5rem;font-weight: 500">
				                <c:if test="${detail.earning>0}">
				               	 	+<span>￥${detail.earning}</span>分享额度
				                </c:if>
				                <c:if test="${detail.expenditure>0}">
				               	 	-<span>￥${detail.expenditure}</span>分享额度
				                </c:if>
							</b>
			            </div>
			        <%--      <div class="aui-card-list-content-padded">
