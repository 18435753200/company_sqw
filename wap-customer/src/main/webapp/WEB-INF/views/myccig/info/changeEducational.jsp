...
<input type="hidden" id="basePath" value="<%=basePath %>"/>	
	<!-- <div class="headly">
	    ...
	    <h3>修改学历<em class="rd" onclick="checkEducational()">确定</em></h3>
    ...
    <header class="aui-bar aui-bar-nav">
        ...
        <div class="aui-title">修改学历</div><em class="qd" onclick="checkEducational()">确定</em>
	</header>
	<div class="wrap">
	    <ul class="form-list">
	        <li>
	            ...
	            <div class="field">
	                <input type="text" class="w"  id="_educational" value="${fn:escapeXml(educational)}" placeholder="请输入学历"/>
	            </div>
	        </li>
       </ul>
	</div>
