...
<input type="hidden" id="basePath" value="<%=basePath %>"/>	
	<!-- <div class="headly">
	    ...
	    <h3 style="background-color:#e60012;color: white;">修改昵称 <em class="rd" onclick="checkNickName()">确定</em></h3>
    ...
    <header class="aui-bar aui-bar-nav">
        ...
        <div class="aui-title">修改昵称</div><em class="qd" onclick="checkNickName()">确定</em>
	</header>
	<div class="wrap">
	    <ul class="form-list">
	        <li>
	            <div class="field">
	                <input type="text" class="w" name="nickName" id="nickName" value="${fn:escapeXml(nickName)}" />
	            </div>
	        </li>
       </ul>
       <div class="errorp">
       <p>1-10中文、英文、数字、字母组合</p>
       </div>
	</div>
