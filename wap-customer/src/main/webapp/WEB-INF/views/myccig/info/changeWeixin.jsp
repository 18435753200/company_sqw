...
<input type="hidden" id="basePath" value="<%=basePath %>"/>	
	<!-- <div class="headly">
	    ...
	    <h3>修改微信号<em class="rd" onclick="checkWeixin()">确定</em></h3>
    ...
    <header class="aui-bar aui-bar-nav">
        ...
        <div class="aui-title">修改微信号</div><em class="qd" onclick="checkWeixin()">确定</em>
	</header>
	<div class="wrap">
	    <ul class="form-list">
	        <li>
	            <div class="fieldd">
	                <input type="text" class="w"  id="_weixin" value="${fn:escapeXml(weixin)}" placeholder="请输入微信号"/>
	            </div>
	        </li>
       </ul>
	</div>
