...
<header class="aui-bar aui-bar-nav">
        <a class="aui-pull-left aui-btn" href="${path }/wealth/startShouYin?source=1">
...
<div class="list-wrapper list-wrapper-hook">
  ...
  <script src="${staticFile_s}/commons/js/index_shouYinJiLuUser.js"></script> 
  <script type="text/javascript" src="${staticFile_s}/commons/js/main.js"></script>
...
$("#birth").live("change", function() {
	...
	window.location ="${path }/wealth/userMoneyJL?day="+startTime+"&supplierId="+supplierId; 
});
//比较日期
