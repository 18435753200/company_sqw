...
<script>
    $(function () {
        $('.btn-sure').on('click', function () {
        	...
        	var _dataType = "text";
        	var _type = "POST";
        	var _url = $("#path").val()+"/cusOrder/shengXianValidate";
        	...
        	$.ajax({
        		...
        		success : function(res) {
        			if (res == "1") {
        				location.href=$("#path").val()+"/orderPay/tradePwdPageForShengXian?shopUserId="+shopUserId+"&shopRealName="+shopRealName+"&price="+price;	
        			}else{
        				showMsg(res);
        			} 
        		},
