...
<body style="font-size: 12px;">
	...
	<div class="opercdbox">
		<div class="header">
			<a class="gobak" href="javascript:goBack();"></a> 会员企业号商品
		</div>
			...
			<div class="fl-cont-box">
				<div class="active">
					<table>
						...
						<tr>
							<td>订单号</td>
							<td>${supplierNumRecord.orderNo}</td>
						</tr>
						
						
						<tr>
							<td>开始时间</td>
							<td><fmt:formatDate value="${supplierNumRecord.startDate}"
						...
						<tr>
							<td>购买金额</td>
							<td>${supplierNumRecord.amountOfMoney}</td>
						</tr>
					</table>
					<c:if test="${cusBusStates!=0 }">
					<c:if test="${supplierNumStates==2 }">
						<a href="javascript:;" onclick="notice();" class="jiaTing">登陆会员企业号</a>
					...
					<c:if test="${cusBusStates==0 }">
						<a
							href="http://pop.zhongjumall.com/supplier/registUI3?userid=${userId }"
							class="jiaTing">注册会员企业号</a>
					</c:if>
				</div>
			</div>
		</div>
