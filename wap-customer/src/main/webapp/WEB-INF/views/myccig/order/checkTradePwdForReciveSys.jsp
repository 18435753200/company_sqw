...
<input type="hidden" id="shopUserId" value="${shopUserId}"/>
<input type="hidden" id="shopRealName" value="${shopRealName}"/>
...
<div class="section">
    ...
    <div class="wrap">
        ...
        <div class="goods-price"> ${payPrice}</div>
        <div class="pwd-box">
        ...
        <div class="forgetpwd"><a href="<%=path %>/trade/toRetrieve">忘记密码?</a></div>
...
$(function () {
    ...
    $(".btn-sure").on('click', function () {
		...
		$.ajax({
			type : "post",
			url :$("#path").val()+"/cusOrder/reciveMoneySysPay",
			data:{"pwd":pwd,"shopUserId":shopUserId,"shopRealName":shopRealName,"price":price},
			dataType : "json",
			success : function(data){
				...
				case "1":	 
					...
					window.setTimeout(function(){
						var url = $("#path").val()+"/customer/toMy";
					...
					break;
				case "2":	
			        location.href="${customer_domain}/trade/toSetting";
					break;	
				...
				case "10":	 
			        ...
			        window.setTimeout(function(){
						var url = $("#path").val()+"/cusOrder/toMyReciveMoney";
						var confirmTag = "<form name='billPayment-form' action=" + url + " method='post'></form>";
						$("body").find("form[name='billPayment-form']").remove();
						$("body").append(confirmTag);
						$("form[name='billPayment-form']").submit(); 
