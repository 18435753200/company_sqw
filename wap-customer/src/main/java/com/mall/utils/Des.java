...
public class Des {
	...
	public static void main(String[] args) {
		Des desObj = new Des();
		/*
		 * String key1 = "1"; String key2 = "2"; String key3 = "3";
		 */
		System.out.println("---------------加密--------------");
		String data = "admin";
		String str = desObj.strEnc(data, "13503517865");
		System.out.println(str);
		System.out.println("---------------解密----------------");
		String dec = desObj.strDec("279AC3C0441419B41F29183F692E0A12",
				"13503517865");
//		dec = desObj.strDec("025B5ACB68A7D15CA97BA767B211A0C5DB50BFBB1F6D0051",
//				"18910801898");
	 ...
	 * String firstKey, String secondKey, String thirdKey
	 */
	public static String strEnc(String data, String mobile) {

		String firstKey = mobile.substring(5, 6);
		String secondKey = mobile.substring(8, 9);
		String thirdKey = mobile.substring(4, 5);
	 ...
	 */
	public static String strDec(String data, String mobile) {
		String firstKey = mobile.substring(5, 6);
		String secondKey = mobile.substring(8, 9);
		String thirdKey = mobile.substring(4, 5);
		int leng = data.length();
