...
public class RemoteServiceSingleton {
	...
	@SuppressWarnings("finally")
	public SupplierLogisticService getSupplierLogisticService() {
		SupplierLogisticService supplierLogisticService = null;
		try {
			supplierLogisticService = (SupplierLogisticService) context
					.getBean("supplierLogisticService");
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
		} finally {
			return supplierLogisticService;
		}
	}
