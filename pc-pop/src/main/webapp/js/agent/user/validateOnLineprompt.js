...
//    		validateSettings.error.run(option, option.prompts.error);
    ...
    emRegCompany_validate: function () {
     ...
     /*   $("#companyarea").jdValidate(validatePrompt.companyarea, validateFunction.checkSelectGroup, true);*/
        ...
        $("#tele").jdValidate(validatePrompt.tele, validateFunction.tel, true);
...
//        $("#mer-brand").jdValidate(validatePrompt.brand, validateFunction.companyname, true);
        ...
        $("#kaptcha").jdValidate(validatePrompt.kaptcha, validateFunction.kaptcha, true);
...
*/
//        $("#hqqPwd").jdValidate(validatePrompt.hqqPwd, validateFunction.hqqPwd, true);
//        $("#hqqPwdRepeat").jdValidate(validatePrompt.hqqPwdRepeat, validateFunction.hqqPwdRepeat, true);
...
//        自己修改的
        return validateFunction.FORM_submit(["#regName", "#pwd", "#pwdRepeat",  "#companyname", "#contactname","#mer-cgr","#kaptcha","#userName","#userMobile"]);//,"#skunum"
...
$("#tele").jdValidate(validatePrompt.tele, validateFunction.tel);
...
$("#kaptcha").jdValidate(validatePrompt.kaptcha, validateFunction.kaptcha);
...
//    validateFunction.pwdstrength();}).jdValidate(validatePrompt.hqqPwd, validateFunction.hqqPwd);
//$("#hqqPwdRepeat").jdValidate(validatePrompt.hqqPwdRepeat, validateFunction.hqqPwdRepeat);
