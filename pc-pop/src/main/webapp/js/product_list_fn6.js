...
function getDownProduct(s){
	...
	$.ajax({
		type : "post", 
		url  : CONTEXTPATH+"/supplier/lookTradingFlow?supplierId="+supplierId,
		data : {'supplierId': supplierId,'page':page,'startTime':startTime,'endTime':endTime},
		dataType: "html",
		success : function(msg) { 
			checkClick(s);
			$("#c3").html(msg);
