...
function logisticPageTpl(){
	window.parent.location=host+"/order/getLogisticPageTpl"
}
function getLogistic(){
	window.parent.location=host+"/order/getLogisticPage";
}

function getAreaOrder(){
	window.parent.location=host+"/order/getAreaOrder";
}
//退款订单
function getRefundOrder(){
	window.parent.location=host+"/order/getCustomerRefundOrderList";
}
