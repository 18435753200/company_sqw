if($("#language").val() == "en"){
    ...
    $.extend(validatePrompt3, {
        companyname: {
            onFocus: "与企业合法证明文件上的公司名称一致",
            succeed: "",
            isNull: "请输入公司名称",
            error: {
...
//    		validateSettings.error.run(option, option.prompts.error);
   ...
   /* userName:function (option) {
    ...
    emRegCompany_validate: function () {
        ...
        $("#regName").jdValidateee(validatePrompt3.regName, validateFunction.regName, true);
        $("#pwd").jdValidateee(validatePrompt3.pwd, validateFunction.pwd, true);
        $("#pwdRepeat").jdValidateee(validatePrompt3.pwdRepeat, validateFunction.pwdRepeat, true);

        $("#companyname").jdValidateee(validatePrompt3.companyname, validateFunction.companyname, true);
       /* $("[name = companyNature]:checkbox").jdValidate(validatePrompt.companytype, validateFunction.checkGroup, true);*/
        $("#companytype").jdValidateee(validatePrompt3.companytype, validateFunction.companytype, true);
        $("#companyaddr").jdValidateee(validatePrompt3.companyaddr, validateFunction.companyaddr, true);
        $("#companyarea").jdValidateee(validatePrompt3.companyarea, validateFunction.companyarea, true);

     /*   $("#companyarea").jdValidate(validatePrompt.companyarea, validateFunction.checkSelectGroup, true);*/

        $("#contactname").jdValidateee(validatePrompt3.contactname, validateFunction.companyname, true);
        $("#tele").jdValidateee(validatePrompt3.tele, validateFunction.tel, true);
        $("#mailbox").jdValidateee(validatePrompt3.mail3, validateFunction.mail, true);
        $("#contacttele").jdValidateee(validatePrompt3.contacttele, validateFunction.tel, true);
        $("#postalcode").jdValidateee(validatePrompt3.postalcode, validateFunction.postalcode, true);
        $("#fileField").jdValidateee(validatePrompt3.textfield, validateFunction.fileField, true);
        $("#fileField1").jdValidateee(validatePrompt3.textfield1, validateFunction.fileField1, true);
        $("#fileField2").jdValidateee(validatePrompt3.textfield2, validateFunction.fileField2, true);

        $("#mer-cgr").jdValidateee(validatePrompt3.cgr, validateFunction.mercgr, true);
//        $("#mer-brand").jdValidate(validatePrompt.brand, validateFunction.companyname, true);
        ...
        $("#kaptcha").jdValidateee(validatePrompt3.kaptcha, validateFunction.kaptcha, true);
       /* $("#userTj").jdValidateee(validatePrompt3.userTj, validateFunction.userTj, true);*/
        $("#sjSupplierId").jdValidateee(validatePrompt3.sjSupplierId, validateFunction.sjSupplierId, true);
...
*/
        $("#hqqPwd").jdValidateee(validatePrompt3.hqqPwd, validateFunction.hqqPwd, true);
        $("#hqqPwdRepeat").jdValidateee(validatePrompt3.hqqPwdRepeat, validateFunction.hqqPwdRepeat, true);
        /*$("#userName").jdValidate(validatePrompt3.userName, validateFunction.userName, true);
        $("#userMobile").jdValidate(validatePrompt3.userMobile, validateFunction.userMobile, true);*/
        return validateFunction.FORM_submit(["#regName", "#pwd", "#pwdRepeat", "#companytype", "#companyaddr", "#companyarea", "#companyname", "#contactname", "#tele", "#mailbox","#contacttele","#postalcode","#fileField","#fileField1","#fileField2","#mer-cgr","#kaptcha","#hqqPwd","#hqqPwdRepeat"]);//,"#skunum"
...
$("#pwd").bind("keyup", function () {
    validateFunction.pwdstrength();}).jdValidateee(validatePrompt3.pwd, validateFunction.pwd);
$("#pwdRepeat").jdValidateee(validatePrompt3.pwdRepeat, validateFunction.pwdRepeat);
$("#regName").jdValidateee(validatePrompt3.regName, validateFunction.regName);

$("#companyname").jdValidateee(validatePrompt3.companyname, validateFunction.companyname);
$("#companytype").jdValidateee(validatePrompt3.companytype, validateFunction.companytype);
$("#companyaddr").jdValidateee(validatePrompt3.companyaddr, validateFunction.companyaddr);
$("#companyarea").jdValidateee(validatePrompt3.companyarea, validateFunction.companyarea);

$("#contactname").jdValidateee(validatePrompt3.contactname, validateFunction.companyname);
$("#tele").jdValidateee(validatePrompt3.tele, validateFunction.tel);
$("#mailbox").jdValidateee(validatePrompt3.mail, validateFunction.mail);
$("#contacttele").jdValidateee(validatePrompt3.contacttele, validateFunction.tel);
$("#postalcode").jdValidateee(validatePrompt3.postalcode, validateFunction.postalcode);
$("#fileField").jdValidateee(validatePrompt3.textfield, validateFunction.fileField);
$("#fileField1").jdValidateee(validatePrompt3.textfield1, validateFunction.fileField1);
$("#fileField2").jdValidateee(validatePrompt3.textfield2, validateFunction.fileField2);

$("#mer-cgr").jdValidateee(validatePrompt3.cgr, validateFunction.mercgr);
...
$("#kaptcha").jdValidateee(validatePrompt3.kaptcha, validateFunction.kaptcha);
/*$("#userTj").jdValidateee(validatePrompt3.userTj, validateFunction.userTj);*/
$("#sjSupplierId").jdValidateee(validatePrompt3.sjSupplierId, validateFunction.sjSupplierId);
...
*/
/*$("#userName").jdValidate(validatePrompt3.userName, validateFunction.userName);
$("#userMobile").jdValidate(validatePrompt3.userMobile, validateFunction.userMobile);
*/
$("#hqqPwd").bind("keyup", function () {
    validateFunction.pwdstrength();}).jdValidateee(validatePrompt3.hqqPwd, validateFunction.hqqPwd);
$("#hqqPwdRepeat").jdValidateee(validatePrompt3.hqqPwdRepeat, validateFunction.hqqPwdRepeat);
