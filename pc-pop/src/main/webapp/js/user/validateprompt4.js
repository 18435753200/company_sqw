...
//    		validateSettings.error.run(option, option.prompts.error);
    ...
    emRegCompany_validate: function () {
        ...
        $("#regName").jdValidatea(validatePrompt4.regName, validateFunction.regName, true);
        $("#pwd").jdValidatea(validatePrompt4.pwd, validateFunction.pwd, true);
        $("#pwdRepeat").jdValidatea(validatePrompt4.pwdRepeat, validateFunction.pwdRepeat, true);

        $("#companyname").jdValidatea(validatePrompt4.companyname, validateFunction.companyname, true);
       /* $("[name = companyNature]:checkbox").jdValidate(validatePrompt.companytype, validateFunction.checkGroup, true);*/
        $("#companytype").jdValidatea(validatePrompt4.companytype, validateFunction.companytype, true);
        $("#companyaddr").jdValidatea(validatePrompt4.companyaddr, validateFunction.companyaddr, true);
        $("#companyarea").jdValidatea(validatePrompt4.companyarea, validateFunction.companyarea, true);

     /*   $("#companyarea").jdValidate(validatePrompt.companyarea, validateFunction.checkSelectGroup, true);*/

        $("#contactname").jdValidatea(validatePrompt4.contactname, validateFunction.companyname, true);
        $("#tele").jdValidatea(validatePrompt4.tele, validateFunction.tel, true);
        $("#mailbox").jdValidatea(validatePrompt4.mail, validateFunction.mail, true);
        $("#contacttele").jdValidatea(validatePrompt4.contacttele, validateFunction.tel, true);
        $("#postalcode").jdValidatea(validatePrompt4.postalcode, validateFunction.postalcode, true);
        $("#fileField").jdValidatea(validatePrompt4.textfield, validateFunction.fileField, true);
        $("#fileField1").jdValidatea(validatePrompt4.textfield1, validateFunction.fileField1, true);
        $("#fileField2").jdValidatea(validatePrompt4.textfield2, validateFunction.fileField2, true);

        $("#mer-cgr").jdValidatea(validatePrompt4.cgr, validateFunction.mercgr, true);
//        $("#mer-brand").jdValidate(validatePrompt.brand, validateFunction.companyname, true);
        ...
        $("#kaptcha").jdValidatea(validatePrompt4.kaptcha, validateFunction.kaptcha, true);
        $("#userTj").jdValidatea(validatePrompt4.userTj, validateFunction.userTj, true);
        $("#sjSupplierId").jdValidatea(validatePrompt4.sjSupplierId, validateFunction.sjSupplierId, true);
...
*/
        $("#hqqPwd").jdValidatea(validatePrompt4.hqqPwd, validateFunction.hqqPwd, true);
        $("#hqqPwdRepeat").jdValidatea(validatePrompt4.hqqPwdRepeat, validateFunction.hqqPwdRepeat, true);
        $("#userName").jdValidatea(validatePrompt4.userName, validateFunction.userName, true);
        $("#userMobile").jdValidatea(validatePrompt4.userMobile, validateFunction.userMobile, true);
        return validateFunction.FORM_submit(["#regName", "#pwd", "#pwdRepeat", "#companytype", "#companyaddr", "#companyarea", "#companyname", "#contactname", "#tele", "#mailbox","#contacttele","#postalcode","#fileField","#fileField1","#fileField2","#mer-cgr","#kaptcha","#userTj","#userName","#userMobile","#hqqPwd","#hqqPwdRepeat"]);//,"#skunum"
...
$("#pwd").bind("keyup", function () {
    validateFunction.pwdstrength();}).jdValidatea(validatePrompt4.pwd, validateFunction.pwd);
$("#pwdRepeat").jdValidatea(validatePrompt4.pwdRepeat, validateFunction.pwdRepeat);
$("#regName").jdValidatea(validatePrompt4.regName, validateFunction.regName);

$("#companyname").jdValidatea(validatePrompt4.companyname, validateFunction.companyname);
$("#companytype").jdValidatea(validatePrompt4.companytype, validateFunction.companytype);
$("#companyaddr").jdValidatea(validatePrompt4.companyaddr, validateFunction.companyaddr);
$("#companyarea").jdValidatea(validatePrompt4.companyarea, validateFunction.companyarea);

$("#contactname").jdValidatea(validatePrompt4.contactname, validateFunction.companyname);
$("#tele").jdValidatea(validatePrompt4.tele, validateFunction.tel);
$("#mailbox").jdValidatea(validatePrompt4.mail, validateFunction.mail);
$("#contacttele").jdValidatea(validatePrompt4.contacttele, validateFunction.tel);
$("#postalcode").jdValidatea(validatePrompt4.postalcode, validateFunction.postalcode);
$("#fileField").jdValidatea(validatePrompt4.textfield, validateFunction.fileField);
$("#fileField1").jdValidatea(validatePrompt4.textfield1, validateFunction.fileField1);
$("#fileField2").jdValidatea(validatePrompt4.textfield2, validateFunction.fileField2);

$("#mer-cgr").jdValidatea(validatePrompt4.cgr, validateFunction.mercgr);
...
$("#kaptcha").jdValidatea(validatePrompt4.kaptcha, validateFunction.kaptcha);
$("#userTj").jdValidatea(validatePrompt4.userTj, validateFunction.userTj);
$("#sjSupplierId").jdValidatea(validatePrompt4.sjSupplierId, validateFunction.sjSupplierId);
...
*/
$("#userName").jdValidatea(validatePrompt4.userName, validateFunction.userName);
$("#userMobile").jdValidatea(validatePrompt4.userMobile, validateFunction.userMobile);

$("#hqqPwd").bind("keyup", function () {
    validateFunction.pwdstrength();}).jdValidatea(validatePrompt4.hqqPwd, validateFunction.hqqPwd);
$("#hqqPwdRepeat").jdValidatea(validatePrompt4.hqqPwdRepeat, validateFunction.hqqPwdRepeat);
