if($("#language").val() == "en"){
    ...
    $.extend(validatePrompt, {
        ...
        textfield1: {
            onFocus: "详情文件限于 xls,xlsx 格式",
            succeed: "",
            isNull: "",
            error: {
                badFormat: "<span>详情文件限于 xls,xlsx 格式<span>",
            }
        },
        cgr: {
            onFocus: "",
...
*/
        return validateFunction.FORM_submit(["#regName", "#pwd", "#pwdRepeat", "#companyaddr", "#companyarea", "#companyname", "#contactname", "#tele", "#mailbox","#contacttele","#postalcode","#fileField","#fileField1","#mer-cgr"]);//,"#skunum"
