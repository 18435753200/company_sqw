				...
				success:function(data){
					...
					if(data=="1"){
						$.dialog.confirm('保存成功，是否继续发布商品？', function(){
							...
							window.location.href="../product/toCreateUIXf?cid="+cateId;
							}, function(){
		...
		$.each(chima,function(i,n){
			if(i == 0){
				...
				tr2 = $("<tr ><td id='' class='yan' rowspan='"+ chimlen +"'></td><td class='chi' id='"+ n.id +"'>"+ n.value +"</td><td></td><td>" +
						...
						"<td  ><input class='hqj_price' name='hqj'  type='text'  value=''></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text'  value=''></td></tr>");
				...
				tr1 = $("<tr><td class='chi'>"+ n.value +"</td><td id='"+ n.id +"'>" +
						"<input class='pro_price' type='text' name='skuCode'><input type='hidden' name='barCodeImg' value='Http://image01.zhongjumall.com/h0/group1/1'/></td></tr>");
				...
				tr2 = $("<tr><td class='chi'>"+ n.value +"</td><td style='display: none;'><input class='productCode_input' type='text' name='productCode'></td><td id='"+ n.id +"'>" +
						"<input class='price_id_input' type='hidden' name='priceId'><input class='price_domesticPrice_input' id='domesticPrice' type='text' name='domesticPrice'></td><td><input class='price_unitPrice_input' id='unitPrice' readonly='readonly' name='unitPrice' type='text'  value=''></td><td style='display: none;'><input class='price_bestoayPrice_input' type='text' name='bestoayPrice' value='0'></td>" +
						"<td ><input class='hqj_price'   type='text'  name='hqj' value=''></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text' name='fhed' value=''></td></tr>");
		...
		$.each(yanse,function(i,n){
			...
			tr2 = $("<tbody><tr><td class='yan' id='"+ n.id +"'>"+ n.value +"</td><td class='chi' id=''></td><td></td><td>" +
					"<input class='pro_price' type='text'></td><td><input class='pro_price' type='text'  value=''></td>" +
						"<td><input class='hqj_price' name='hqj'  type='text'  value=''></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text' value=''></td></tr></tbody>");
			...
			$.each(chima,function(j,m){
				if(j == 0){
					...
					tr2 = $("<tr ><td class='yan' id='"+ n.id +"' rowspan='"+ chimlen +"'>"+ n.value +"</td><td class='chi' id='"+ m.id +"'>"+ m.value +"</td><td style='display: none;'><input class='productCode_input' type='text' name='productCode'></td><td>" +
							"<input class='price_id_input' type='hidden' name='priceId'><input class='price_domesticPrice_input' type='text' id='domesticPrice' name='domesticPrice'></td><td><input class='price_unitPrice_input' id='unitPrice' readonly='readonly' name='unitPrice' type='text'  value=''></td><td style='display: none;'><input class='price_bestoayPrice_input' type='text' name='bestoayPrice' value='0'></td>" +
			...
			$.each(chima,function(j,m){
				...
				if(j == 0 && k == 0){
					...
					tr1 = $("<tr ><td class='yan' id='"+ n.id +"' rowspan='"+ chimlen*chimlen2 +"'>"+ n.value +"</td>" +
							"<td class='chi' id='"+ m.id +"'>"+ m.value +"</td>" +
							"<td class='chi' id='"+ l.id +"'>"+ l.value +"</td>" +
							"<td><input class='pro_price' type='text' name='skuCode'><input type='hidden' name='barCodeImg' value='Http://image01.zhongjumall.com/h0/group1/1'/></td></tr>");
					...
					tr2 = $("<tr ><td class='yan' id='"+ n.id +"' rowspan='"+ chimlen*chimlen2 +"'>"+ n.value +"</td>" +
							...
							"<input class='price_domesticPrice_input' id='domesticPrice'  type='text' name='domesticPrice'></td>" +
							"<td><input class='price_unitPrice_input' id='unitPrice' readonly='readonly' name='unitPrice' type='text'  value=''></td>" +
