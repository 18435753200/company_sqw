...
function changefh(event) {
	...
	trthis.find('.price_unitPrice_input').val(
			Math.round(parseFloat($(unitpri).val() * scj)));
	/* trthis.find('.hqj_price').val(Math.round(parseFloat(Math.round(parseFloat($(unitpri).val()*scj))*hqj))); */
	trthis.find('.fhed_price').val(
			Math.round(parseFloat($(unitpri).val() * scj * fhed)));
