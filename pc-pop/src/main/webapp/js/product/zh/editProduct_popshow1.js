				...
				success:function(data){
					...
					if(data=="1"){
						$.dialog.confirm('保存成功，是否返回到商品列表？', function(){
							window.location.href="../product/onSaleList?page="+$("#page").val()+"&dpro="+$("#dpro").val();
							}, function(){
	...
	if(chilen >= 1){
		$(".chim").each(function(e,n){
			if(e == 0){
				...
				var title = $(this).children("td:eq(0)").find('input[type=\'text\']').val();
				$(".cm1").show();
				$(".cm1 span").text(title);
			}
			if(e == 1){
		...
		$.each(chim,function(i,n){
			if(i == 0){
				...
				tr2 = $("<tr ><td id='' class='yan' rowspan='"+ chimlen +"'></td><td class='chi' id='"+ n.id +"'>"+ n.value +"</td><td>" +
						...
						"<td ><input class='hqj_price' type='text' readonly='readonly' value='' disabled='disabled'></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text'  value=''></td></tr>");
				...
				tr1 = $("<tr><td class='chi'>"+ n.value +"</td><td id='"+ n.id +"'>" +
						"<input class='pro_price' type='text' name='skuCode'><input class='pro_sku_id' type='hidden' name='skuId'></td><td><div class='preview_fake'  id='-"+n.id+"_img' ></div></td><td><input class='file'  id='-"+n.id+"_upload' name='button'   type='submit' /></td></tr>");
				...
				tr2 = $("<tr><td class='chi'>"+ n.value +"</td><td style='display: none;'><input class='productCode_input' type='text' name='productCode'></td><td id='"+ n.id +"'>" +
						...
						"<td ><input class='hqj_price' type='text' readonly='readonly' name='hqj' value='' disabled='disabled'></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text' name='fhed' value=''></td></tr>");
		...
		$.each(yanse,function(i,n){
			...
			tr2 = $("<tbody><tr><td class='yan' id='"+ n.id +"'>"+ n.value +"</td><td class='chi' id=''></td><td>" +
					"<input class='pro_price' type='text'></td><td><input class='pro_price' type='text'  value=''></td>" +
						"<td ><input class='hqj_price' type='text' readonly='readonly' value='' disabled='disabled'></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text' value=''></td></tr></tbody>");
		...
		$.each(yanse,function(i,n){
			...
			$.each(chim,function(j,m){
				$.each(chim2,function(k,l){
					...
					tr1.append($("<td><input class='pro_price' type='text' name='skuCode'><input class='pro_sku_id' type='hidden' name='skuId'><input type='hidden' name='barCodeImg' value='Http://image01.zhongjumall.com/h0/group1/1'/></td>"));
					...
					tr2.append($("<td style='display: none;'><input class='productCode_input' type='text' name='productCode'></td><td>" +
						...
						"<td ><input class='hqj_price' type='text' name='hqj' readonly='readonly' disabled='disabled'></td><td style='display: none;'><input class='fhed_price' readonly='readonly' type='text' name='fhed'></td>"));
					tbody.append(tr);
					tbody1.append(tr1);
					tbody2.append(tr2);
				});
					...
					if(typeof(chi_id2)!="undefined"&&typeof(chi_id3)!="undefined"&&typeof(chi_id4)=="undefined"){
						if(chi_id == tableInfo[k][1][0] && chi_id2 == tableInfo[k][1][1] && chi_id3 == tableInfo[k][1][2]){
							...
							if(tablename == "tb-skuprice" && typeof (tableInfo[k][4]) != 'undefined'){
								...
								$(item1).find(".productCode_input").val(tableInfo[k][8]);
								if(typeof(hqj)!="undefined"&&typeof(fhed)!="undefined"){
									$(item1).find(".hqj_price").val(tableInfo[k][6]*hqj);
									$(item1).find(".fhed_price").val(tableInfo[k][6]*fhed);
								}else{
									$(item1).find(".hqj_price").val(tableInfo[k][9]);
									$(item1).find(".fhed_price").val(tableInfo[k][10]);
	...
	if(chilen >= 1){
		$(".chim").each(function(e,n){
			if(e == 0){
				chim = $(this).find('input[type=\'checkbox\']');
				var title = $(this).children("td:eq(0)").find('input[type=\'text\']').val();
				$(this).children("td:eq(0)").find('input[type=\'text\']').next().val(title);
				$(".cm1").show();
				$(".cm1 span").text(title);
			}
			if(e == 1){
