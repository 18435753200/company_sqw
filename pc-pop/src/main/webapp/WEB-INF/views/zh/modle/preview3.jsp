...
<body>
	...
	<div class="header">
		<div class="nav">
			...
			<ul>
				<li  class="on"><a href="${path}/store/modle/preview?modleNum=3"><img src="${path}/images/pc.png"><i></i></a></li>
				<li><a href="${path}/store/modle/mobile?modleNum=3"><img src="${path}/images/mobile.png"><i></i></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="cont">
    	<a href="#"><img src="${path}/images/te5.jpg"></a>
	</div>
