             ...
             <!--                         代理地区：  省 市 区 -->
							<div class="item" id="">
								...
								<div class="item-ifo" >
									...
									<select style="background-color:#EAEAE3" name="province" id="province" disabled="disabled" ><option value="" >省代理</option></select>
                        ...
                        <!--                         营业地址 -->
                         ...
                         <!--                         注册地址 -->
                          <div class="item" id="">
                            ...
                            <div class="item-ifo">
                                <input type="text" id="registerAddress" name="registerAddress" class="text"  tabindex="5"   value="${sr.registerAddress }" disabled="disabled"/>
                            </div>
                        </div>
