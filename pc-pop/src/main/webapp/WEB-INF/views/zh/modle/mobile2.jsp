...
<body class="bo">
	...
	<div class="header">
		<div class="nav">
			...
			<ul>
				<li><a href="${path}/store/modle/preview?modleNum=2"><img src="${path}/images/pc.png"><i></i></a></li>
				<li class="on"><a href="${path}/store/modle/mobile?modleNum=2"><img src="${path}/images/mobile.png"><i></i></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="cont mr">
	    <div class="pic">
	    	<div class="ov">
	    	    <a href="#"><img src="${path}/images/te6.jpg"></a>
	    	</div>
	    </div>
	</div>
