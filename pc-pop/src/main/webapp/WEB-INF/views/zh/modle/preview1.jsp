...
<body>
	...
	<div class="header">
		<div class="nav">
			...
			<ul>
				<li  class="on"><a href="${path}/store/modle/preview"><img src="${path}/images/pc.png"><i></i></a></li>
				<li><a href="${path}/store/modle/mobile"><img src="${path}/images/mobile.png"><i></i></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="cont">
	    <a href="#"><img src="${path}/images/te1.jpg" ></a>
	</div>
