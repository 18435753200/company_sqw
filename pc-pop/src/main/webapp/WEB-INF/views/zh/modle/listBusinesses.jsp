...
<head>
    ...
    <script type="text/javascript" src="${path }/js/product_list_fn5.js"></script>
				...
				<div class="c3" id="cp3">
					...
					<div class="xia">
						<form action="javascript:void(0)">
							...
							<p class="p1" >
								<span>&nbsp;&nbsp;&nbsp;&nbsp;商品类型 ：</span>
								<select id="popProdType">
									<option value="">请选择</option>
									<option value="6">千品王商品</option>
									
								</select>
							</p>
							<p class="p3">
								<button type="submit" id="subfm" onclick="clickSubmit()">搜索</button>
								<button type="submit" id="subfm" onclick="clickSubmit()">添加</button>
