		...
		$(document).ready(function(){
			$("#hetong").submit(function(){
				...
				$("#supplier input[type='text']").each(function(){
					if($(this).val()==""){
						$("#errorMessage").text("海港或者机场未填写 ，请输入");
						$("#errorMessage").show();
						isSubmit = false;
					}else{
						$("#errorMessage").hide();
...
<%-- 			
			...
			<div class="top1">
				<div class="mmf-mod f_l">
					<h2 title="${contract.basContracts.dealerName}">买方the Buyer ：<input type="text" disabled="disabled" class="txt-line" value="${fn:escapeXml(contract.basContracts.dealerName)}"/></h2>
					<div class="p1">
						<p title="${contract.basContracts.address}"><span>地址Address ：</span><input type="text" class="txt-line" value="${fn:escapeXml(contract.basContracts.address)}"/></p>
				...
				<div class="mmf-mod f_r">
					<h2 title="${contract.basContracts.supplierName}">卖方the seller ：<input type="text" disabled="disabled" class="txt-line" value="${fn:escapeXml(contract.basContracts.supplierName)}"/></h2>
					<div class="p1">
						<p><span>地址Address ：</span><input type="text" disabled="disabled" class="txt-line" value="${fn:escapeXml(contract.basContracts.sAddress)}"/></p>
						...
						<p><span>邮箱Email :</span><input type="text" disabled="disabled" class="txt-line" value="${fn:escapeXml(contract.basContracts.sEmail)}"/></p>
					</div>
				</div>
			</div> --%>
...
based on the characteristics of the goods, with all costs and fees relating born and paid by the Seller. 
		...
		<span id="shipPackMsg" style="color: red;display:none;">请选择或者输入货物运输包装</span><br>
	<span id="salePackageMsg" style="color: red;display:none;">请选择或者输入货物销售包装</span><br>
	</div>
...
l be provided by the Seller and confirmed by the Buyer.
			...
			<div class="he5">
				...
				<input required="required" type="text" class="txt-line" id="airPortOfShipmentCn" name="airPortOfShipmentCn"/>机场 
				Port of Shipment:<input type="text" required="required" id="seaPortOfShipmentEn" name="seaPortOfShipmentEn" class="txt-line" />Main Seaport/
				<input type="text" name="airPortOfShipmentEn" required="required" id="airPortOfShipmentEn" class="txt-line" />Main Airport <br>
				<span id="errorMessage" style="color: red;display: none;">请填写空白字段</span> </h3>
				<h3>8、目的港/机场：<input type="text" class="txt-line" disabled="disabled" value="${fn:escapeXml(contract.basContracts.portAirportCn)}"/>
				Port/Airport of Destination:<input type="text" class="txt-line" disabled="disabled" value="${fn:escapeXml(contract.basContracts.portAirportEn)}"/></h3>
			...
			<div class="he7">
				<h3>12、验收：验收在买方收到货物后      日内进行。如果试验结果全部符合合同规定的相应要求,买方签署验收证明。Inspection: The Buyer shall inspect the goods within    days after receipt of the goods. When the inspection proved to be in conformity with all specifications as stipulated in the Contract, an Acceptan
...
guage of arbitration shall be Chinese</p>
	...
	<!-- 	 我已阅读进口合同,并同意签署<input type="checkbox" value="" id="qiandingbox" name="qiandingbox">
	<button type="button" style="width:200px; height:30px; background:#fa4800;color:#fff;border: none;" id="qiandingBtn"">提交合同</button>
 -->	<input type="submit" id="editContract" style="width:200px; height:30px; background:#fa4800;color:#fff;border: none;" value="提交合同" >
		</div>
	</form>
</div>
<div class="fhui">
