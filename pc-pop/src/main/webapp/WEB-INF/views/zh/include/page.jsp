...
<link rel="stylesheet" type="text/css" href="${path}/css/reset.css">
	...
	<div class="shang">
		...
		<c:if test="${page.totalPage > 1}">
			 ...
			 <c:if test="${page.page> 1}">
				 <a href="#"><button type="button"  class="y" onclick="GoPage(${page.page-1});" ><img src="${path}/images/x5.png"> 上一页</button></a>
		     </c:if>
			...
			<c:if test="${page.totalPage>8&&page.page>8}">
			 ...
			 <c:if test="${page.page == page.totalPage}">
		      	 <button type="button"  class="y1"> 下一页<img src="${path}/images/x8.png"></button>
		     </c:if>
			 <c:if test="${page.page< page.totalPage}">
				 <a href="#"><button type="button" class="y1" onclick="GoPage(${page.page+1})"  > 下一页<img src="${path}/images/x9.png"></button></a>
		     </c:if>
		  </c:if>
		 <c:if test="${page.totalPage>1}">
