...
<!-- 						<li> -->
<%-- 							<a href="${path}/product/getPro">商家中心</a> --%>
<!-- 				    	</li> -->
				

				  
				    	<c:if test="${ !empty meunMap['代理管理'] && empty meunMap['商家列表']}" >
						<li>
							<a href="${path}/supplier/getAgentPage">商家中心</a>
				    	</li>
				    </c:if>
				    	<c:if test="${ !empty meunMap['代理管理'] && !empty meunMap['商家列表']}" >
						<li>
							<a href="${path}/supplier/listBusiness">商家中心</a>
				    	</li>
				    </c:if>
				    	<c:if test="${ !empty meunMap['商品管理'] && empty meunMap['代理管理']}" >
						<li>
							<a href="${path}${defaultUrlMapReslut['商家中心']}">商家中心</a>
				    	</li>
				    </c:if>
...
<%-- 					<p class="f_l"><img src="${path}/images/img_heard.png" alt=""></p> --%>
					<p class="f_l"><img src="${path}/images/head.png" alt=""></p>
					   <c:if test="${!empty supplier.icon}"> 
					   		<%-- <li><img src="${supplier.icon}"  height="32" alt=""></li> --%>
					   </c:if>
					  
						<li class="m1">${loginUser.loginName}
							 <c:if test="${!empty  sa}">(${sa.name })</c:if>
						 </li>
