	...
	$("#saveStore").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				if(data=="1"){
					window.open('http://www.zhongjumall.com/store/'+supplierId  +'/'+ templateType +'/index.html?online=2');
					//location.href='http://www.zhongjumall.com/store/'+supplierId  +'/'+ templateType +'/index.html';
