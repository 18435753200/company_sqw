...
<!-- 							</div> -->
	...
	<div class="w" id="regist">
        ...
        <form id="formcompany"  method="post" action="${path}/supplier/addAgentModel" enctype="multipart/form-data" >
...
<!--                         <h3 style="width:810px">运营商地区</h3> -->
<!--                          运营商级别 --> 
<!--  						<div class="item" id=""> -->
<!--                             <span class="label"><b class="ftx04">*</b>运营商级别：</span> -->
<!--                             <div class="item-ifo"> -->
<%--                                 <input type="text"  class="text"  value="${supplierAgentType.name }"   disabled="disabled"/> --%>
<%--                                 <input type="hidden" name="agentCode" value="${supplierAgentType.code }" /> --%>
<!--                             </div> -->
<!--                         </div> -->
...
<!-- 								<div class="item-ifo" >  -->
<!-- 									<select id="province" name="province"  ><option value="" >省运营商</option></select> -->
...
<!-- 					企业账户信息 -->
						<!-- 用户名 -->
                        <h3 style="width:810px">商家系统信息</h3>
                        <div class="item" id="">
...
<!--                          验证码 -->
    ...
    <script type="text/javascript" src="${path}/js/agent/user/registValidate.js"></script>
