...
<html>
    ...
    <div class="mc">
        ...
        <form id="formcompany"  method="post" action="${path}/supplier/updateAgentMessage" enctype="multipart/form-data" >
...
<!--                      注册名称 -->
                        <div class="item" id="select-regName">
                            ...
                            <div class="f1 item-ifo">
                                <input type="text" name="name" class="text" disabled="disabled"  value="${sr.name }"/>
                            </div>
                        </div>
                        ...
                        <div class="item" id="select-regName">
                            ...
                            <div class="f1 item-ifo">
                                <input type="text" id="nameJC" name="nameJC" class="text"    value="${sr.nameJC }"
                                       autocomplete="off"    />
...
<!-- 							邮箱 -->
                        ...
                        <!--                         企业法人名称 -->
                          <div class="item" id="">
                            ...
                            <div class="item-ifo">
                                <input type="text" id="legalPerson" name="legalPerson" class="text"   value="${sr.legalPerson }"  />
                        ...
                        <!--                         企业法人电话 -->
                          <div class="item" id="">
                            ...
                            <div class="item-ifo">
                                <input type="text" id="legalPhone" name="legalPersonPhone" class="text"   value="${sr.legalPersonPhone }"  />
                                <label class="blank" id="legalPhone_succeed"></label>
...
<!--                         上传能够证明企业合法性的证明文件： -->
                        ...
                        <div class="item-ifo" style="width:320px;">
                            <input id="companyLegitimacyUrlTextField" class="text" type="text" name="companyLegitimacyUrlTextField" readonly="readonly" tabindex="11">
                                <span id="filespan">
                                <label for="fileField"  onClick="document.getElementById('textfield').focus();" >
                                    <input id="fileField" class="file" type="file" onchange="document.getElementById('companyLegitimacyUrlTextField').value=this.value;validateFileSize(this,'companyLegitimacyUrlTextField','200')"   size="28" name="companyLegitimacy" 
                                      />
...
<!-- 					公司详情文件： -->
					<div class="item" id="" >
                            ...
                            <div class="item-ifo" style="width:320px;">
                                ...
                                <input id="fileField1" class="file" type="file" onchange="document.getElementById('companyDetailedUrlTextField').value=this.value;uploadFile(this,'companyDetailedUrlTextField')" size="28" name="companyDetailed" />
...
<%-- 	<script type="text/javascript" src="${path}/js/agent/user/validateRegExp.js"></script> --%>
<%--     <script type="text/javascript" src="${path}/js/agent/user/validateprompt.js"></script> --%>
