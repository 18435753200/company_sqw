						...
						<div class="p_box">
							...
							<div class="p3" id="attrobjs">
								<div class="bb">
									...
									<span class="dpl-tip-inline-warning" style="display: none;">商品备注不能大于200字</span>
									<p class="blank10"></p>
								</div>
									...
									<div class="tab_box" style="margin-left:60px;" id="skuCodeTable">
										...
										<table cellspacing="0" cellpadding="0" border="0" style="margin-top:10px;" id="tb-tiaoxingma" width="100%">
											...
											<tr >
												...
												<th style="display: none;">上传条形码图片</th>
											</tr>
											</thead>
											<tbody>
											</tbody>
							...
							<div class="i_box">
								...
								<div class="mingxi">
									<div class="mm">
										<p class="m2">
											<span>审核意见：</span>
											<textarea id="rejectReason" readonly name="rejectReason" cols="60" rows="5">${rejectReason}</textarea>
										</p>
									</div>
								</div>
							</div>
...
<script type="text/javascript" src="${path}/js/product/zh/webuploaderhandler_show.js"></script>
