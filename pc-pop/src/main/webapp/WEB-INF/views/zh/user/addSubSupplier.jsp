		...
		<div class="wrap">
			...
			<div class="right f_l">
				...
				<div class="w" id="regist">
				    <div class="mc">
				        <form id="formcompany"  method="post" action="${path}/subsupplier/save" enctype="multipart/form-data" >
				                    ...
				                    <div class="form ">
				                        ...
				                        <div class="item" id="select-regName">
				                            ...
				                            <c:out value="${name}"></c:out>
				                                <input type="text" id="companyname" name="companyName" value="" class="text" 
				                              ...
				                              <select  id="companyarea" name ="countryArea"   rel="select"  tabindex="4">
											    <option value="-1" selected="selected"><spring:message code="supplier.pleaseSelect" /></option>
											      <c:forEach items="${country}" varStatus="status" var="coun">
											         <option id="${coun}" value="${coun}" code="${callingCode[status.index]}" >${coun}</option>
											    </c:forEach>
											  </select>
				                        ...
				                        <div class="item" id="" >
				                         ...
				                         <div class="item" id="" >
				                            <span class="label"><spring:message code="supplier.companyDetailFile" />：(<a href="${template_url}"><spring:message code="supplier.companyDetailFileTemplate" /></a> ) </span>
				                            <div class="item-ifo" style="width:320px;">
				                      ...
				                      <br>
				                        <div class="item">
				                           ...
				                           <div class="item-ifo">
				                            <input type="button" class="btn-img sub_btn" id="registsubmit"  tabindex="21" value="添加" >
...
<script type="text/javascript" src="${path}/js/user/zh/validateprompt.js"></script>
