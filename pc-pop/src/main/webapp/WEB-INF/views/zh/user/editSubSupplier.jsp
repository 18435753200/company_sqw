				                    ...
				                    <div class="form ">
				                        ...
				                        <div class="item" id="">
				                            ...
				                            <div class="item-ifo">
				                              <select  id="companyarea" name ="countryArea"   rel="select"  tabindex="4">
											    <option value="-1"><spring:message code="supplier.pleaseSelect" /></option>
				                        ...
				                        <div class="item" id="" >
				                            ...
				                            <c:if test="${not empty data.companyLegitimacyUrl }">
				                                ...
				                                <input class="btn" type="button" value="变更"   tabindex="12" >
				                                </label>
				                               </span>
										     ...
										     <!--    <span id="filespan" class="divfile">
							                       ...
							                       <input class="btn" type="button"  value="变更"   style="float: none;" tabindex="12"   >
					                      		 </span> -->
				                         ...
				                         <div class="item" id="" >
				                          ...
				                          <c:if test="${not empty data.companyDetailedUrl }">
				                                ...
				                                <input class="btn" type="button" value="变更"   tabindex="14" >
				                                </label>
				                               </span>
				                      ...
				                      <br>
				                        <div class="item">
				                           ...
				                           <div class="item-ifo">
				                            <input type="button" class="btn-img sub_btn" id="registsubmit"  tabindex="21" value="修改" >
