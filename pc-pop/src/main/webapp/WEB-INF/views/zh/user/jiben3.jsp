...
// 			$("#submitButton").click();
	...
	<script type="text/javascript">
		function checkInfo(){
			var managerBackup = $("#managerBackup").val().trim();
			var managerTelBackup = $("#managerTelBackup").val().trim();
			var kfTelBackup = $("#kfTelBackup").val().trim();
			var countryAreaBackup = $("#countryAreaBackup").val().trim();
			var addressBackup = $("#addressBackup").val().trim();
			var contactBackup = $("#contactBackup").val().trim();
			var phoneBackup = $("#phoneBackup").val().trim();
			var emailBackup = $("#emailBackup").val().trim();
// 			var faxBackup = $("#faxBackup").val().trim();
// 			var postBackup = $("#postBackup").val().trim();
			var textfield2 = $("#textfield2").val().trim();
			if(managerBackup == "" || managerTelBackup == "" || kfTelBackup == "" || countryAreaBackup =="" || addressBackup == "" 
					|| contactBackup == "" || phoneBackup == "" || emailBackup == "" ){
				return 1;
			}
			var manager = $("#manager").val().trim();
			var managerTel = $("#managerTel").val().trim();
			var kfTel = $("#kfTel").val().trim();
			...
			if(managerBackup == manager && managerTelBackup == managerTel && kfTelBackup == kfTel && countryAreaBackup == countryArea 
					&& addressBackup == address && contactBackup == contact && phoneBackup == phone && emailBackup == email 
					&& faxBackup == fax && postBackup == post){
				return 3;
			}else{
				return 2;
			}
		...
		<div class="right f_l">
			...
			<div class="cont">
				<ul class="ul_vertical">
					...
					<!-- <li class="blank20"></li> -->
					<%-- <li>
						<p class="p1"><b style=" color: #FF0000;">*</b>企业个人账户ID：</p>
						<input type="hidden" id="userId" name="userId" value="${fn:escapeXml(user.userId)}"/>
						<input class="i1" id ="userId1" name="userId" value="${fn:escapeXml(user.userId)}" readonly="readonly"/>
					</li>
					<li class="blank20"></li>
					<li>
						<p class="p1"><b style=" color: #FF0000;">*</b>企业个人账户手机号：</p>
						<input type="hidden" id="userMobileId" name="userMobile" value="${fn:escapeXml(user.mobile)}"/>
						<c:if test="${not empty user.mobile}">
							<input class="i1" id ="userMobileId1" name="userMobile1" value="${fn:substring(user.mobile,0,3)}****${fn:substring(user.mobile,7,11)}" readonly="readonly"/>
						</c:if>
						<c:if test="${empty user.mobile}">
							<input class="i1" id ="userMobileId1" name="userMobile1" value="" readonly="readonly"/>
						</c:if>
					</li> --%>
					<%-- <li class="blank20"></li>
					<li>
						<p class="p1"><b style=" color: #FF0000;">*</b>上级企业编号：</p>
						<input type="hidden" id="sjSupplierId1" name="sjSupplierId" value="${fn:escapeXml(sjSupplier.supplierCode)}"/>
						<input class="i1" id ="sjSupplierId" name="sjSupplierId" value="${fn:escapeXml(sjSupplier.supplierCode)}" readonly="readonly" />
					</li> --%>
					<%-- <li class="blank20"></li>
					<li>
				...
				<%-- 	<li class="blank20"></li>
					<li>
						...
						<input class="i1" id ="userTj" name="userTj11" value="${fn:substring(data.userTj,0,3)}****${fn:substring(data.userTj,7,11)}" readonly="readonly" />
						<input type="hidden" id="userTj" name="userTj" value="${fn:escapeXml(data.userTj)}"/>
					</li> --%>
					<li class="blank20"></li>
					<li>
					...
					<li>
						...
						<input class="i1" id ="managerTelBackup" name="managerTelBackup" value="${fn:escapeXml(data.managerTel)}"/>
						<input type="hidden" id="managerTel" name="managerTel" value="${fn:escapeXml(data.managerTel)}"/>
					</li>
					<li class="blank20"></li>
					<li>
