	...
	<div class="mc">
		...
		<div class="formpwd">
			<div class="item"> <span class="label">账户名：</span>
				<div class="fl">
					<input type="text" tabindex="1" class="text text-color" onfocus="usernameOnfocus();" onblur="usernameOnblur();" id="username" name="username" value="用户名">
			...
			<div class="item"> <span class="label">验证码：</span>
				<div class="fl">
					...
					<label class="img"><img id="JD_Verification1" src="${path}/supplier/validateCode?uid=${uid}" alt="验证码" style="cursor:pointer;width:100px;height:26px;" /></label>
					<label class="ftx23">&nbsp;看不清？<a class="flk13" href="javascript:changeCode();">换一张</a></label>
					<span class="clr"></span>
					<label id="authCode_error" class=""></label>
				</div>
			</div>
			<div class="item"> <span class="label"></span>
				<input type="button" tabindex="4" value="下一步"  id="findPwdSubmit" class="btn-img btn-entry">
			</div>
		</div>
		</form>
...
<!-- 	<div style="width: 1020;text-align: center;margin: 0 auto;background: url(../images/f.jpg) repeat-x;height: 50px;"> -->
<!-- 	 	<ul> -->
<!-- 	 		<li style="padding-top: 15px;color: #4b4b4b;margin: 0 8px 0 0;">unicorn</li> -->
<!-- 	 	</ul> -->
<!-- 	</div> -->
</html>
