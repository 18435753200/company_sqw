				...
				<div class="cont">
						...
						<div class="p_box">
							...
							<div class="p3" id="attrobjs" >
								<div class="bb">
									...
									<p class="t2">
										<input name="name" type="text" id="otherBrand">
									...
									<p class="s_1">
									<select name="type">
											<option value="2">Own Brand</option>
											<option value="1">Exclusive Agent</option>
					...
					<div class="i_box">
							...
							<span class="dpl-tip-inline-warning" id="Details"></span>
							 <script id="editor"  type="text/plain" style="width:818px;"></script>
    						</div>
...
$(document).ready(function(){
	inituploader("Brand Qualification Pictures","00",[]);
	...
	$("#saveBrand").click(function(){
		var isSubmit = true;
			...
			if(""==otherBrand){
				isSubmit = false;
				$("#brandMsg").text("Please enter the brand name").show();
			} else if(otherBrand.length>200){
				isSubmit = false;
				$("#brandMsg").text("Brand name is not greater than 200 words").show();
			} else {
				$("#brandMsg").hide();
			}
