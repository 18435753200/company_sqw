		...
		<div class="box">
			<ul class="ul_horizontal u2">
				<li><a href="${path}/user/index">Home</a></li>
					<c:if test="${ !empty defaultUrlMapReslut['商家中心']}" >
						<li>
							<a href="${path}${defaultUrlMapReslut['商家中心']}">Seller Center</a>
				    	</li>
				    </c:if>
				<c:if test="${ !empty defaultUrlMapReslut['用户中心']}" >
					<li>
	                <a href="${path}${defaultUrlMapReslut['用户中心']}">User Center</a>
	                </li>
			    </c:if>
				<!-- <li><a href="#">联系客服</a></li> -->
...
<!-- 			<div class="eng">
 ...
 -->			<div class="t_user f_r">
	        <c:if test="${  !empty defaultUrlMapReslut['用户中心']}" >
					...
					<a href="${path}${defaultUrlMapReslut['用户中心']}">
					<c:if test="${!empty supplier.icon}"> 
						...
						<li class="m3" onclick="clearCookie()" style="cursor:pointer;color:#FFF" >LogOut</li>
				    </ul>
