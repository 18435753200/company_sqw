...
<div class="right f_l">
	...
	<form method="post" id="productAction" enctype="multipart/form-data">
		...
		<c:forEach items="${proObj.supplierProductSkuDTOs}" var="skuHide" varStatus="skui">
			...
			<input type="hidden"  name="supplierProductSkuDTOs[${skui.index }].supplierProductSku.skuNameCn" value="${skuHide.supplierProductSku.skuNameCn}"/>
			<input type="hidden"  name="supplierProductSkuDTOs[${skui.index }].supplierProductSku.skuNameEn" value="${skuHide.supplierProductSku.skuNameEn}"/>
			<input type="hidden"  name="supplierProductSkuDTOs[${skui.index }].supplierProductSku.skuId" value="${skuHide.supplierProductSku.skuId}"/>
		</c:forEach>
		<div class="right f_l">
			<div class="c21">
				<div class="title">
...
<%-- 						<p class="t1">Supply ability：</p>
				...
				<c:choose>
					...
					<c:otherwise>
						<button type="button" id="editProd" class="fabu_btn" >Edit Product</button>
					</c:otherwise>
				</c:choose>
