				                    ...
				                    <div class="form ">
				                      ...
				                      <!--   <div class="item" id="">
				                        ...
				                        <div class="item" id="">
				                            ...
				                            <div class="item-ifo">
				                                ...
				                                <i class="i-name"></i>
				                                <label id="realname_error" class="error" style="display: none"> Login Name id Registed</label>
				                      ...
				                      <br>
				                        <div class="item">
				                           ...
				                           <div class="item-ifo">
				                            <input type="button" class="btn-img sub_btn" id="registsubmit"  tabindex="21" value="Save" >
