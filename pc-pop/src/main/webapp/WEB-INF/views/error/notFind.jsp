	...
	<section class="bd clearfix">
		<div class="module-error">
			<div class="error-main clearfix">
				<div class="label"></div>
				<div class="info">
					<h3 class="title"><spring:message code="error.404message1" /></h3>
					<div class="reason">
						<p><spring:message code="error.404message2" /></p>
						<p><spring:message code="error.404message3" /></p>
						<p><spring:message code="error.404message4" /></p>
					</div>
					<div class="oper">
