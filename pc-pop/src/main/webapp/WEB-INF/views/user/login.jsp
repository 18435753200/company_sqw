...
<head>
	...
	<link rel="shortcut icon" href="${path}/images/favicon1.png" />
...
<%--     <img src="${path}/images/login-logo-sm2.png" alt="<spring:message code="logo" />" width="170" height="60"/> --%>
    </a>
    <%--
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; 
             background: url('${path}/images/login-sm1.png') no-repeat scroll 0px 0px transparent; position: absolute;">
