...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <style type="text/css">
     ...
     $(document).ready(function (){
    	 var type=$("#registType").val();
    	 if(type==1){
    		 $("#select-regName2").hide();
    		 $("#select-regName").show();
    	 }else{
    		 $("#select-regName").hide();
    		 $("#select-regName2").show();
    	 }
    	getAllProvince()
    	})
	...
	$("#cityId option").remove();
	 ...
	 var _dataType = "text";
	 var _type = "POST";
	 var  _url = '${path}/limit/getProvince';
	 var _async = true;
	 $.ajax({
		 dataType:_dataType,
		 type:_type,
...
<div class="w" id="regist">
    ...
    <div class="mc">
        ...
        <form id="formcompany"  method="post" action="${path}/supplier/registPartnerAdd" enctype="multipart/form-data" >
                ...
                <div class="mc " id="bgDiv"> -->
                    <div class="form ">
                        <h3><spring:message code="supplier" /><span class="tishi-<spring:message code="language" />"><spring:message code="supplier.tishi" /></span></h3>
                         ...
                         <div class="item">
                            <span class="label"><b class="ftx04">*</b><spring:message code="请选择你要入驻的角色" />：</span>
                            <div class="f1 item-ifo">
                            <c:out value="${name}"></c:out>
                                <!-- <input type="text" id="companyname" name="companyName" onblur="checkName1();" value="区域运营商名称" class="text" 
                                       autocomplete="off"  tabindex="1"/> -->
                                       <select id="registType" name="registType" onclick="registChange()" >
                                       	<option value="1">区域运营商</option>
                                       	<option value="2">区域代理商</option>
                                       </select>
                        ...
                        <div class="item" id="select-regName">
                            <span class="label"><b class="ftx04">*</b><spring:message code="supplier.companyName2" />：</span>
                            <div class="f1 item-ifo">
                            <c:out value="${name}"></c:out>
                                <input type="text" id="companyname" name="companyName" onblur="checkName1();" value="区域运营商名称" class="text" 
                                       autocomplete="off"  tabindex="1"/>
                           ...
                           <div class="item" id="select-regName2">
                            <span class="label"><b class="ftx04">*</b><spring:message code="区域代理商名称" />：</span>
                            <div class="f1 item-ifo">
                            <c:out value="${name}"></c:out>
                                <input type="text" id="companyname2" name="companyName" onblur="checkName1();" value="区域代理商名称" class="text" 
                                       autocomplete="off"  tabindex="1"/>
                                <label id="company_error" class="error" style="display: none"> <spring:message code="user.comNameRegisted" /></label>
                                <label id="companyname_succeed" class="blank"></label>
                                <label id="companyname_error"></label>
                        ...
                        <div class="item" id="">
                            <span class="label"><b class="ftx04">*</b><spring:message code="代理或运营区域" />：</span>
                            <div class="item-ifo">
                                
                             <!--   <input type="text" id="companyarea" name="countryArea" class="text" tabindex="3"/>   --> 
                             
                              
                                <select  id="provinceId" name="productProvinceid" onchange="getCity()" >
							      <option>请选择</option>
							    </select>
							    <select  id="cityId" name="productCityid" onchange="getCounty()">
							      <option>请选择</option>
							    </select>
							    <select  id="areaId" name="productAreaid">
							      <option>请选择</option>
							    </select>
...
<!--                         </div> -->
                        ...
                        <div class="item" id="">
                            <span class="label"><b class="ftx04">*</b><spring:message code="supplier.managerTele" />：</span>
                            <div class="item-ifo">
                                <input type="text" id="managerTel" name="managerTel" class="text"  tabindex="5" />
...
<div class="w">
    ...
    <script type="text/javascript" src="${path}/js/user/validateRegExp4.js"></script>
    <script type="text/javascript" src="${path}/js/user/validateprompt4.js"></script>
