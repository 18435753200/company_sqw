...
<div class="w" id="regist">
    ...
    <div class="mc">
        ...
        <form id="formcompany"  method="post" action="${path}/supplier/regist3" enctype="multipart/form-data" >
...
<div class="w">
    ...
    <script type="text/javascript" src="${path}/js/user/validateRegExp3.js"></script>
    <script type="text/javascript" src="${path}/js/user/validateprompt3.js"></script>
...
function changeCode() {  //刷新
	...
	<script type="text/javascript" src="${path}/js/user/industry_func3.js"></script>
		 <!-- 底部 start -->
